 ...
 * @version    $Id: Registry.php 1440 2008-12-17 03:40:10Z jquick $
 */
...
class Zend_Registry extends ArrayObject
{
    ...
    {
    	$registryClassName = new self::$_registryClassName();

        self::setInstance($registryClassName);
    }
