...
class Submittal extends IntegratedMapper
{
	/**
	 * Class name for use in deltifyAndSave().
	 */
	protected $_className = 'Submittal';
	 ...
	 * Constructor
	 */
	public function __construct($database, $table='submittals')
	{
	...
	*/
	 ...
	 */
	public static function findById($database, $submittal_id,$table='submittals', $module='Submittal')
	{
