...
$arrOutput = array(
	...
	'attributeName' => $attributeName, // E.g. "project_name"
	...
	'newValue' => $newValue, // E.g. "Tst Project" to "Test Project"
	...
	'formattedAttributeName' => $formattedAttributeName, // E.g. "Project Name"

	// Previous HTML Record unique id (Some updates may change a candidate key attribute value - may not change)
	'previousId' => $uniqueId, // Old pk/uk value - previousId in javascript - may not be different than uniqueId in javascript
