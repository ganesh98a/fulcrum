...
$arrOutput = array(
	...
	'errorMessage' => $errorMessage, // E.g. "Error Creating Project Record" Comes from this ajax code
	...
	'dummyId' => $uniqueId, // Old pk/uk dummy placeholder - dummyId in javascript
	...
	'htmlRecordType' => $htmlRecordType, // E.g. "tr" or "li"

	// HTML Record template name
	//'htmlRecordTemplate' => $htmlRecordTemplate,

	// HTML Record Itself
	'htmlRecord' => $htmlRecord, // HTML itself

	// HTML Record Itself
	//'htmlRecordList' => $htmlRecordList, // HTML itself

	// HTML Record Itself
	//'htmlContent' => $htmlContent, // HTML itself
