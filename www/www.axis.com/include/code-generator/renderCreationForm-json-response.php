...
$arrOutput = array(
	...
	'errorMessage' => $errorMessage, // E.g. "Error Rendering Project Creation Form" Comes from this ajax code

	// Below come from get input or are set to defaults via patterns
	// New HTML Record Attribute Group Name
	'attributeGroupName' => $attributeGroupName, // E.g. "manage-project-record" - New HTML Record Attribute Group Name
	...
	'uniqueId' => $uniqueId, // New Id - uniqueId in javascript
	...
	'newAttributeGroupName' => $newAttributeGroupName, // E.g. "create-project-record" - Previous HTML Record Attribute Group Name
	...
	'htmlRecordCreationFormType' => $htmlRecordCreationFormType, // E.g. "tabularDataRowHorizontalCreationForm" or "li"

	// HTML Record Itself
	'htmlRecordCreationForm' => $htmlRecordCreationForm, // HTML itself

	// Dom Reference element
	'optionalReferenceElementId' => $optionalReferenceElementId, // Reference element for "prepend" or "insert" or "append"

	// Dom Reference element
	'performCreationFormAppendOperation' => $performCreationFormAppendOperation, // Reference element for "prepend" or "insert" or "append"
