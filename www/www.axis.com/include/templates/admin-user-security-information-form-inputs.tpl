...
{if (isset($userRole) && ($userRole == 'global_admin'))}
<tr>
...
<td>
	...
	<tr>
	<td width="10%">
	{if (isset($userCompanyName) && !empty($userCompanyName)) }
	{$userCompanyName}
	{/if}
...
<td>
	...
	<tr>
	<td width="10%">
	{include file="dropdown-user-role-list.tpl"}
	</td>
	<td>* Required Field</td>
	</tr>
	</table>
...
<td>
	<table border="0" cellpadding="0" cellspacing="0">
	<tr>
	<td><input type="password" name="password" value="{$password}" maxlength="30" size="25" tabindex="110" style="width:150px;"></td>
	<td>* Required Field</td>
	</tr>
	</table>
</td>
...
<td>
	<table border="0" cellpadding="0" cellspacing="0">
	<tr>
	<td><input type="password" name="password2" value="{$password2}" maxlength="30" size="25" tabindex="111" style="width:150px;"></td>
	<td>* Required Field</td>
	</tr>
	</table>
</td>
...
<td>
	<table border="0" cellpadding="0" cellspacing="0">
	<tr>
	<td><input type="button" onclick="window.location='/admin-user-password-reset.php?user_id={$user_id}&email={$emailUrlEncoded}'" value="Generate Password and Send to User"></td>
	<td></td>
	</tr>
	</table>
</td>
