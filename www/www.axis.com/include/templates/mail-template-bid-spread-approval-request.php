...
*/
?>
<a href="<?php echo $uri->https . 'login-form.php'; ?>"><img style="border: 0; border: none;" width="200" height="40" border="0" src="<?php echo $cdn; ?>images/logos/axis-green-white-background.gif" alt="Fulcrum Construction Management Software"></a><br>
<small style="color: #ccc; padding-left: 10px;">Construction Management Software</small>
<?php
	//echo $htmlAlertMessageBody;
	$subcontent = $htmlAlertMessageBody;
	include('templates/square-corners-bid-spread-approval-request.php');
?>
</div>
