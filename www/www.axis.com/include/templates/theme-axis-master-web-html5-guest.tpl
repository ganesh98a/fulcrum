					...
					<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td class="bgGray" id="logo" style="padding: 5px 0;width:200px;">
								<img alt="" src="{$logo}" width="150" height="35">
							</td>
							<td align="left" class="bgGray">
								<span>
								<h2 style="margin:5px 0;"><div style="float: left;">{$projectName|escape:'htmlall'}: {$softwareModuleFunctionLabel|escape}</div></h2>
									<div align="right" style="margin-top: 10px;">{$cur_date}</div>
								</span>
							</td>
						</tr>
					</table>
						...
						<td style="padding-left:15px;" id="contentAreaRight" align="left">
							<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									...
									<td align="left" style="{$secondstyle}">
