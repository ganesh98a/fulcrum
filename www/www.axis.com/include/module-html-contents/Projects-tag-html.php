...
<head>
<title>Tagging -$project_name</title>
	<meta charset="utf-8">
...
$buildRoomTable= renderTagsListView($project_id,$user_company_id,$currentlyActiveContactId,$userCanManagePunch);
...
if ($javaScriptDebugMode) {
	...
	<script src="/js/projectTags.js"></script>
