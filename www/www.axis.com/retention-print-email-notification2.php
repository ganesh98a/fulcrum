...
/** Draw Grid Html Content Starts **/
	...
	$drawGridRawContent = renderRetentionDrawGridHtmlForPDF($database,$project_id, $last_draw_id, $draw_application_number,true,$options_draw,$corDisplay,$cost_code_alias,$ret_id);

	$drawCOGridRawContent = renderRetentionChangeOrderGridHtmlForPDF($database,$project_id, $last_draw_id, $draw_application_number, true, $options_draw,$corDisplay,$cost_code_alias,$ret_id);
...
/** Overall Total Starts **/
	...
	// Total PREVIOUS RETAINAGE
	$totalPrevRetainer = $drawGridRawContent['totalPrevRetainerValue'] + $drawCOGridRawContent['totalPrevRetainerValue']; 
	$totalPrevRetainerFormatted =  $totalPrevRetainer ? formatNegativeValues($totalPrevRetainer) : '$0.00';
...
if ($corDisplay == 1) {
	...
	<tr class="change_orders_row">
	  ...
	  <td class="textBold textAlignRight" nowrap>$totalPrevRetainerFormatted</td>
	  $overallnarrativeHtml
	</tr>
...
if(!empty($architectureBlock) && $architectureBlock =='true'){
	...
	<table class="appArchitectTable" cellpadding="5">
		...
		<tr>
			<td class="fontSize11 width50per">
				<div class="floatLeft" >By:</div>
				<div class="floatLeft width175px tdBottomBorder1 marginRight5 marginLeft5">&nbsp;</div>
			</td>
			<td class="fontSize11 width50per">
				<div class="floatLeft" >Date:</div>
				<div class="floatLeft tdBottomBorder1 width100px">&nbsp;</div>
			</td>
...
<html>
	...
	<body id="templateBody">
		...
		<div style="float:right;display:none;"><img src='$fulcrum'></div>
			...
			<h6 class="textAlignCenter headerBackground">CONTRACTOR'S APPLICATION AND  AUTHORIZATION FOR PAYMENT</h6>
			<hr />
			...
			<div class="mainContractTable width100per">
				...
				<div class="width90per tableAlignCenter paddingRight10">

					<table class="appContractPayment" border="0" cellpadding="5" cellspacing="5">
						<tr>
							<td>1. </td>
							<td class="width80per"><span class="textBold fontSize10">ORIGINAL CONTRACT VALUE</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11"> $originalContractValueFormatted</td>
						</tr>
						<tr>
							<td>2. </td>
							<td class="textBold fontSize10">NET CHANGE BY CHANGE ORDER</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11">$netChangeOrdersFormatted</td>
						</tr>
						<tr>
							<td>3. </td>
							<td class="textBold fontSize10">CONTRACT SUM TO DATE (Line 1 +/- Line 2)</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11">$contractSumToDateFormatted</td>
						</tr>
						<tr>
							<td>4. </td>
							<td class="textBold fontSize10">TOTAL COMPLETED & STORED TO DATE (Column G)</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight">$totalCompAndStoredToDateColGFormatted</td>
						</tr>
						<tr>
							<td>5. </td>
							<td class="textBold fontSize10">RETENTION:</td>
							<td class="tdBottomBorder width10per textAlignRight fontSize11">$lessRetentionFormatted</td>
						</tr>
						<tr>
							<td>6. </td>
							<td class="textBold fontSize10">TOTAL EARNED LESS RETENTION (Line 4 Less Line 5 Total)</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11">$totalEarnedLessRetentionFormatted</td>
						</tr>
						<tr>
							<td>7. </td>
							<td class="textBold fontSize10">LESS PREVIOUS CERTIFICATES FOR PAYMENT <br>
							(Line 6 From Prior Application)
							</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11">$lessPrevCertForPaymentFormatted</td>
						</tr>
						<tr>
							<td>8. </td>
							<td class="textBold fontSize10">CURRENT PAYMENT DUE (Line 6 Less Line 7)</td>
							<td class="textBold tdBottomBorder appContractPayment width10per textAlignRight fontSize11">$currentPaymentDueFormatted</td>
						</tr>
						<tr>
							<td>9. </td>
							<td class="textBold fontSize10">BALANCE TO FINISH, PLUS RETENTION (Line 3 Less Line 6)</td>
							<td class="tdBottomBorder width10per appContractPayment textAlignRight fontSize11">$balanceToFinishFomatted</td>
						</tr>
					</table>
				</div>
				<div class="width100per">
					<p class="paragraphTemp">The undersigned Contractor authorizes that to the best of the Contractor's knowledge, information and belief the Work covered by this Application for Payment has been completed in accordance with the Contract Documents, that all amounts have been paid by the Contractor for Work for which previous Certificates for Payment were issued and payments received from the Owner, and that current payment shown herein is now due.</p>
					...
					<h6 class="bottom0 paddingLeft5">AUTHORIZATION FOR PAYMENT</h6>
					<p class="paragraphTemp marBottom0 textIndent10">In accordance with the Contract Documents, based on on-site observations and the data comprising the above application, the following Owner Representativecertifies that to the best of their knowledge, information and belief the Work has progressed as indicated, the quality of Work is in accordance with the Contract Documents, and the Contractor is entitled to payment of the</p>
					<table class="certifiedAmountTable" cellpadding="5">
						<tr>
							<td class="textAlignRight fontSize11"><span class="textBold fontSize11">AMOUNT AUTHORIZED:</span></td>
							<td class="tdBottomBorder textAlignRight fontSize11"><span class="textBold fontSize11">$currentPaymentDueFormatted</span></td>
						</tr>
					</table>
					<table class="appContractorTable" cellpadding="5">
						<tr>
							<td class="textBold fontSize11" colspan="3">OWNER'S REPRESENTATIVE : $ownerName</td>
						</tr>
						<tr>
							<td class="fontSize11 width50per">
								<div class="floatLeft" >By:</div>
					...
					<p class="paragraphTemp marBottom0">This Authorization is not negotiable. The AMOUNT AUTHORIZED is payable only to the Contractor named herein. Issuance, payment and acceptance of payments are wthout prejudice to any rights of the Owner or Contractor under this Contract. </p>
				</div>
			</div>
...
<html>
	...
	<body id="templateBody">
		<div style="float:right;display:none;"><img src='$fulcrum'></div>		
		<table id="drawTemp2" border="0" style="border: 1px solid #adadad;" cellpadding="5" cellspacing="0" width="100%">
			<thead style="font-weight: bold;text-align: center;color: #fff;background: #3b90ce;">
				<tr>
					<td rowspan="2" style="width:80px;">COST CODE</td>
					<td rowspan="2" style="width:150px;">DESCRIPTION OF WORK</td>
					...
					<td rowspan="2" style="width:80px;">MATERIALS PRESENTLY STORED (NOT IN D OR E)</td>
					<td rowspan="2" style="width:80px;">TOTAL COMPLETED AND STORED TO DATE (D + E + F)</td>
					<td rowspan="2" style="width:80px;">% (G / C)</td>
					<td rowspan="2" style="width:80px;">BALANCE TO FINISH (C - G)</td>
					<td rowspan="2" style="width:80px;">TOTAL RETENTION</td>
					<td rowspan="2" style="width:80px;">RETENTION BILLING</td>
					<td rowspan="2" style="width:80px;">PREVIOUS RETAINAGE</td>
					$narrativeHtml
				</tr>
				<tr>
					<td style="width:80px;">FROM PREVIOUS APPLICATION (D+E)</td>
...
$arrActionType = DrawActionTypes::findById($database, $draw_action_type_id, $loadActionTypeOptions);
$actionTypeName = '';
...
if($draw_action_type_option_id != '') {
	$loadActionTypeOptions = new Input();
	$loadActionTypeOptions->forceLoadFlag = true;
	$arrActionTypeOption = DrawActionTypeOptions::findById($database, $draw_action_type_option_id, $loadActionTypeOptions);
	$actionTypeOptionName = '';
...
FileManagerFile::setPermissionsToMatchParentFolder($drawContentTableDatase, $file_manager_file_id, $file_manager_folder_id);
