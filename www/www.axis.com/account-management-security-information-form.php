...
$postBack = Egpcs::sessionGet($applicationLabel, 'account-management-security-information-form.php', 'post');
/* @var $postBack Egpcs */
...
$htmlContent = $template->fetch('account-management-security-information-form.tpl');
