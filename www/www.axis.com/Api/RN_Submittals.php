...
$RN_filterType = '';
if(isset($RN_params['filterType']) && $RN_params['filterType']!=null){
	$RN_filterType = $RN_params['filterType'];
}
$RN_listAll = false;
...
switch($RN_view){
	...
	include_once('./Submittals/SubmittalData.php');
	break;
	case "Pdf":
	/*get the company details & onsite workers*/
	include_once('./Submittals/SubmittalDataPdf.php');
	break;
	default:
	break;
}
