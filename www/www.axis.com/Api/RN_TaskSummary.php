...
$RN_statusId = '';
if(isset($RN_params['statusId']) && $RN_params['statusId']!=null){
	$RN_statusId = $RN_params['statusId'];
}

$RN_version = '';
if(isset($RN_params['version']) && $RN_params['version']!=null){
...
switch($RN_view){
	case "TotalList":
	/* Get count of task*/
	include_once('./TaskSummary/TaskSummaryTotalList.php');
	break;
	case "ListData":
	/*get the task details */
	include_once('./TaskSummary/TaskSummaryList.php');
	break;
	case "AIDateUpdate":
	/*get the task details */
	include_once('./TaskSummary/ActionItemDateUpdate.php');
	break;
	default:
	break;
}
...
if($RN_jsonEC['status'] == 200){
	$RN_GetSoftware_Module_Category_id = 11;
	$RN_GetSoftware_Module_id = 'Dashboard';
