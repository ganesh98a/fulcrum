...
// $objPHPExcel->setActiveSheetIndex()->mergeCells('F'.($index).':J'.($index+2));
/*cell font style*/
// $objPHPExcel->getActiveSheet()->getStyle('F'.($index))->getFont()->setBold(true);
...
if($typecall == null || $typecall == '')
    ...
    $arrSubmittals = Submittal::loadSubmittalsByProjectIdAndDateOpen($database, $RN_project_id, $loadSubmittalsByProjectIdOptions,$RN_reportsStartDate,$RN_reportsEndDate);
$suTableTbody = '';
