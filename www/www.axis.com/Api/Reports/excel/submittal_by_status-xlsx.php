...
$arrSubmittals = Submittal::loadSubmittalsByProjectIdAndStatus($database, $RN_project_id, $loadSubmittalsByProjectIdOptions, $RN_reportsStartDate, $RN_reportsEndDate);
