...
$objPHPExcel->setActiveSheetIndex()->mergeCells('D'.$index.':F'.$index);
...
$arrReturn = renderProjectBidInvitationFilesAsUrlList($database, $RN_project_id);
...
FileManagerFolder::findFolderByVirtualFilePathAndCreateIfNotExistWithPermissions($database, $user->user_company_id, $RN_currentlyActiveContactId, $RN_project_id, $virtual_file_path);
...
$input = new Input();
$input->id = "budgetFileUploader_projectBidInvitations_{$RN_project_id}";
$input->folder_id = $project_bid_invitation_file_manager_folder_id;
$input->project_id = $RN_project_id;
...
$arrCostCodeDivisionsByUserCompanyIdAndProjectId = CostCodeDivision::loadCostCodeDivisionsByUserCompanyIdAndProjectId($database, $user->user_company_id, $RN_project_id);
...
$arrSubcontractorBidStatusCountsByProjectId = SubcontractorBid::loadSubcontractorBidStatusCountsByProjectId($database, $user->user_company_id, $RN_project_id, $cost_code_division_id_filter);
