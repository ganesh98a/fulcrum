...
$arrCommittedContracts = GcBudgetLineItem::loadCommittedContractsByProjectId($database, $RN_project_id, $RN_reportsStartDate, $RN_reportsEndDate ,$loadCommittedContractsByProjectIdOptions);
...
if(count($arrCommittedContracts) > 0){
  foreach ($arrCommittedContracts as $gc_budget_line_item_id => $budgetLineItem) {
    ...
    $arrSubcontracts = Subcontract::loadCommittedSubcontractsByGcBudgetLineItemId($database, $gc_budget_line_item_id, $RN_reportsStartDate, $RN_reportsEndDate, $loadSubcontractsByGcBudgetLineItemIdOptions);
...
$arrUncommittedContracts = GcBudgetLineItem::loadUnCommittedContractsByProjectId($database, $RN_project_id, $loadUncommittedContractsByProjectIdOptions);
