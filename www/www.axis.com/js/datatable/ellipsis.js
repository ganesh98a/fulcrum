...
jQuery.fn.dataTable.render.ellipsis = function ( cutoff, wordbreak, escapeHtml ) {
	...
	return function ( d, type, row ) {
		...
		if ( d.length <= cutoff ) {
			return '<span class="ellipsis" data-placement="bottom" data-toggle="tooltip" title="'+esc(d)+'" data-html="true"><span class="ellipsis_content" style="line-height:30px; padding: 10 18px;" >'+esc(d)+'</span></span>';;
		}
...
// This is for transmittal module
jQuery.fn.dataTable.render.ellipsis_trans = function ( cutoff, wordbreak, escapeHtml ) {
 	var esc = function ( t ) {
 		return t
 		.replace( /&/g, '&amp;' )
 		.replace( '&amp;', '&' )
 	...
 	return function ( d, type, row ) {
		...
		d = d.toString(); // cast numbers
		if ( d.length <= cutoff ) {
			return '<span class="ellipsis" data-placement="bottom" data-toggle="tooltip" title="'+esc(d)+'" data-html="true"><span class="ellipsis_content" style="line-height:20px; padding: 8 18px;" >'+esc(d)+'</span></span>';;
		}
		...
		if(d.length > 25) {
			var elipisString = d.substring(0, 25)+'...';
			return '<span class="ellipsis" data-placement="bottom" data-toggle="tooltip" title="'+esc(d)+'" data-html="true"><span class="ellipsis_content" style="line-height:20px; padding: 8 18px;">'+esc(elipisString)+'</span> </span>';
		}else{
			return '<span class="ellipsis" data-placement="bottom" data-toggle="tooltip" title="'+esc(d)+'" data-html="true"><span class="ellipsis_content" style="line-height:20px; padding: 8 18px;">'+esc(d)+'</span> </span>';
		}
	};
