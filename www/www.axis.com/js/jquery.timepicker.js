...
(function (factory) {
	...
	var methods =
	{
		...
		show: function(e)
		{
			...
			if (selected && selected.length) {
				var ul = list.find('ul');
				var topOffset = ul.scrollTop() + selected.position().top - selected.outerHeight();
				ul.scrollTop(topOffset);
			} else {
				list.scrollTop(0);
			}
	...
	function _render(self)
	{
		...
		if (settings.modifyTimepickerCss) {
			settings.modifyTimepickerCss(wrapped_list);
		}
	}
