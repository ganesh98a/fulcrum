...
/**
 * We (Fulcrum) modified the source to integrate it with our application. Do a
 * case-sensitive search for 'KM' to see our changes as of 12/2014. -Kyle Mulleady
 */
...
qq.UploadButton = function(o) {
    ...
    qq.extend(this, {
        ...
        // Added 12/2014 KM. This method was supposed to already be here.
        dispose: function() {
...
qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        createReadyStateChangedHandler = function(id, xhr) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4) {
                	...
                	// Added 12/2014 KM.
					AjaxUrls.ajaxComplete(ajaxUrl, xhr.responseText);
    ...
    qq.extend(this, {
        ...
        uploadFile: function(id) {
            ...
            // Added 12/2014 KM.
            ajaxUrl = spec.endpointStore.get(id);
...
qq.FineUploader = function(o, namespace) {
    ...
    if (this._options.customLabel) {
    	$(this._options.element).find('.qq-upload-button > div:first-child').html(this._options.customLabel);
    	$(this._options.element).find('.qq-upload-drop-area > span').html('Drop Here');
    }
};
...
(function($) {
    ...
    function destroy(element) {
		for (var i = 0; i < qq.arrFineUploaders.length; i++) {
			var uploader = qq.arrFineUploaders[i];
			var uploaderElement = uploader._options.element;
			if (uploaderElement == element) {
				uploader._disposeSupport.dispose();
				uploader._dnd.dispose();
				var uploaderWidgetElement = $(uploaderElement).find('.qq-uploader');
				uploaderWidgetElement.remove();
				qq.arrFineUploaders.splice(i, 1);
				break;
			}
		}
    }
    ...
    $.fn.fineUploader = function(optionsOrCommand) {
        ...
        this.each(function(index, el) {
            ...
            // Added 12/2014 KM.
            else if (optionsOrCommand == 'destroy') {
				destroy(this);
            }
            else {
