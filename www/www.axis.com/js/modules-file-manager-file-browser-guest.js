...
if ( fileTreeParams.script == undefined ) fileTreeParams.script = '/modules-file-manager-file-browser-guest-ajax.php?method=loadFiles&token='+token+'&pt_token='+pt_token+'&subid='+encodeURIComponent(subid)+'&conid='+encodeURIComponent(conid)+'&fid='+encodeURIComponent(fid);
					...
					if ( self.innerHeight ) {
						...
						if ($(this).parent().hasClass('trash')) {
							...
							if ($(this).parent().attr("class").indexOf('zip') > 0) {
								//$(menu).enableContextMenuItems('#cut,#copy');
...
function searchBoxSetup()
{
	$("#filenameSearch").autocomplete({
		...
		source: 'modules-file-manager-file-browser-guest-ajax.php?method=searchByFilename&token='+token+'&pt_token='+pt_token
	});
...
function createNewFolder()
{
	try {
		...
		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=createNewFolder&token='+token+'&pt_token='+pt_token;
		var ajaxQueryString =
...
function moveItemsToRecycleBin()
{
	try {
		...
		if ( $(".ui-selected").length > 0) {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=moveItemsToRecycleBin&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
...
function permanentlyDeleteItemsFromRecycleBin()
{
	try {
		...
		if ( $(".ui-selected").length > 0) {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=permanentlyDeleteItemsFromRecycleBin&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
			'folders=' + encodeURIComponent(csvMovedFolderListItems) +
			'&files=' + encodeURIComponent(csvMovedFileListItems) +
...
function restoreItemsFromRecycleBin()
{
	try {
		...
		if ( $(".ui-selected").length > 0) {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=restoreItemsFromRecycleBin&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
			'folders=' + encodeURIComponent(csvMovedFolderListItems) +
			'&files=' + encodeURIComponent(csvMovedFileListItems) +
...
function extractZipFile(element)
{
	try {
		...
		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=extractZipFile&token='+token+'&pt_token='+pt_token;
		var ajaxQueryString =
...
function createDownloadWorkflowProgressIndicatorSuccess(data, textStatus, jqXHR)
{
	try {
		...
		if ( $(".ui-selected").length > 0) {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=download&token='+token+'&pt_token='+pt_token+'&conid='+encodeURIComponent(conid)+'&subid='+encodeURIComponent(subid);
			var ajaxQueryString =
			'folders=' + encodeURIComponent(csvMovedFolderListItems) +
			'&files=' + encodeURIComponent(csvMovedFileListItems) +
...
function downloadRightClickSelectedCompressed(element)
{
	try {
		...
		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=download&token='+token+'&pt_token='+pt_token;
		var ajaxQueryString =
		'li_id=' + encodeURIComponent(li_id) +
		'&li_path=' + encodeURIComponent(li_path) +
		'&parent_file_manager_folder_id=' + encodeURIComponent(parent_file_manager_folder_id);
...
function cancelRightClickSelected(element)
{
	...
	$.ajax({
	url: '/modules-file-manager-file-browser-guest-ajax.php?method=extractZipFile',
...
function moveFileOrFolderToNewLocation(event, ui)
{
	try {
		...
		if (new_file_manager_folder_id == '-1') {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=moveFileOrFolderToNewLocation&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
...
function loadPreview(file, theClass)
{
	try {
		...
		//$("#filePreview").load('/modules-file-manager-file-browser-guest-ajax.php?method=loadPreview&file=' + encodeURIComponent(file) + '&height=' + tblHeight + '&isImage=' + isImage);

		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=loadPreview&token='+token+'&pt_token='+pt_token+'&conid='+encodeURIComponent(conid)+'&subid='+encodeURIComponent(subid);
		var ajaxQueryString =
	...
	try {
		...
		if ($(".ui-selected").length > 1) {
			...
			if (id != 0 && id != 'fileTreeMenu') {
				...
				/*var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=loadDetails&token='+token+'&pt_token='+pt_token;
				var ajaxQueryString =
...
function updateNodeNameFromTree(elementId, nodeId, nodeType, fileExt)
{
	try {
		...
		if ($.trim(oldValueNoExtension) != $.trim(newValue)) {
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=updateNodeName&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
			'elementId=' + encodeURIComponent(elementId) +
...
function toggleFileFolderPermission(elementId, nodeType)
{
	try {
		...
		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=toggleFileFolderPermission&token='+token+'&pt_token='+pt_token;
		var ajaxQueryString =
		'elementId=' + encodeURIComponent(elementId) +
		'&nodeType=' + encodeURIComponent(nodeType) +
...
function toggleAllPermissionsForRole(elementId, nodeType)
{
	try {
		...
		var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=toggleAllPermissionsForRole&token='+token+'&pt_token='+pt_token;
		var ajaxQueryString =
		'elementId=' + encodeURIComponent(elementId) +
		'&nodeType=' + encodeURIComponent(nodeType) +
...
function toggleAllPermissionsForRoleSuccess(data, textStatus, jqXHR)
{
	try {
		...
		if (checkAll == 1) {
			$("#" + rowId).find('input').attr('checked', true);
		} else {
			$("#" + rowId).find('input').attr('checked', false);
		}
...
function applyPermissionsToFolderContents(file_manager_folder_id)
{
	try {
		...
		if (answer) {
			...
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=applyPermissionsToFolderContents&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
...
function applyPermissionsToFileSiblings(fileId, elementId)
{
	try {
		...
		if (answer) {
			var ajaxHandler = window.ajaxUrlPrefix + 'modules-file-manager-file-browser-guest-ajax.php?method=applyPermissionsToFileSiblings&token='+token+'&pt_token='+pt_token;
			var ajaxQueryString =
			'parent_file_manager_folder_id=' + encodeURIComponent(parent_file_manager_folder_id) +
