 ...
 */
function createJobsiteSiteworkActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Sitework Activity';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Sitework Activities';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_sitework_activity-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_sitework_activities';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=createJobsiteSiteworkActivity';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteSiteworkActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteSiteworkActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=loadJobsiteSiteworkActivity';
		}
		...
		var jobsite_sitework_activity_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_sitework_activity_id--' + uniqueId;
		if ($("#" + jobsite_sitework_activity_id_element_id).length) {
			var jobsite_sitework_activity_id = $("#" + jobsite_sitework_activity_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_activity_id=' + encodeURIComponent(jobsite_sitework_activity_id);
		}
...
function loadAllJobsiteSiteworkActivityRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=loadAllJobsiteSiteworkActivityRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteSiteworkActivity(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteSiteworkActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=updateJobsiteSiteworkActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteSiteworkActivityAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=updateAllJobsiteSiteworkActivityAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteSiteworkActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Sitework Activity?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=deleteJobsiteSiteworkActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteSiteworkActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities-ajax.php?method=saveJobsiteSiteworkActivity';
		}
...
function buildJobsiteSiteworkActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_sitework_activity_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_sitework_activity_id = parseInputToMySQLUnsignedInt(jobsite_sitework_activity_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_sitework_activity_id=' + encodeURIComponent(jobsite_sitework_activity_id);
			}
		}
		...
		var jobsite_sitework_activity_label_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_sitework_activity_label--' + uniqueId;
		if ($("#" + jobsite_sitework_activity_label_element_id).length) {
			var jobsite_sitework_activity_label = $("#" + jobsite_sitework_activity_label_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_activity_label=' + encodeURIComponent(jobsite_sitework_activity_label);
		}
...
function filterJobsiteSiteworkActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_sitework_activity_id':
