 ...
 */
function createSubcontractTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Subcontract Template';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Subcontract Templates';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-subcontract_template-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'subcontract_templates';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=createSubcontractTemplate';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildSubcontractTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadSubcontractTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=loadSubcontractTemplate';
		}
...
function loadAllSubcontractTemplateRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=loadAllSubcontractTemplateRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateSubcontractTemplate(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterSubcontractTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=updateSubcontractTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllSubcontractTemplateAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=updateAllSubcontractTemplateAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteSubcontractTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Subcontract Template?');
		...
		$("#dialog-confirm").html("Are You Sure That You Want To Delete This Subcontract Template?");
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=deleteSubcontractTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveSubcontractTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates-ajax.php?method=saveSubcontractTemplate';
		}
...
function buildSubcontractTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		var subcontract_type_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--subcontract_type_id--' + uniqueId;
		if ($("#" + subcontract_type_id_element_id).length) {
			var subcontract_type_id = $("#" + subcontract_type_id_element_id).val();
			subcontract_type_id = parseInputToInt(subcontract_type_id);
			ajaxQueryString = ajaxQueryString + '&subcontract_type_id=' + encodeURIComponent(subcontract_type_id);
		}

		var subcontract_template_name_element_id = attributeGroupName + '--' + attributeSubgroupName + '--subcontract_template_name--' + uniqueId;
		if ($("#" + subcontract_template_name_element_id).length) {
			var subcontract_template_name = $("#" + subcontract_template_name_element_id).val();
			ajaxQueryString = ajaxQueryString + '&subcontract_template_name=' + encodeURIComponent(subcontract_template_name);
		}
...
function filterSubcontractTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
...
// To clone a default template
function cloneSubcontractTemplate(templateId, attributeGroupName)
{
	var ajaxHandler = window.ajaxUrlPrefix + 'modules-subcontracts-ajax.php';
	var ajaxQueryString =
	'method=cloneDefaultTemplateItem&subcontract_template_id='+templateId;
			
	var returnedJqXHR = $.ajax({
			url: ajaxHandler,
			data: ajaxQueryString,
			success: cloneSubcontractTemplateSuccess,
			error: errorHandler
		});
}
function cloneSubcontractTemplateSuccess(data, textStatus, jqXHR)
{
	try {
		...
		if(subcontract_template_id == null)
		{
			var messageText = 'Template Already Exists.';
...
function subcontractortemplateDefault(templateid)
{
		var isChecked = $("#makedefault_"+templateid).is(":checked");
        if (isChecked) {
           var value='Y'; 
        } else {
           var value='N';
	...
	var ajaxHandler = window.ajaxUrlPrefix + 'modules-subcontracts-ajax.php';
	var ajaxQueryString =
	'method=MakeDefaultTemplate&templateid='+templateid+'&value='+value+'&contact_id='+contact_id;
