 ...
 */
function createContactToRole(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Contact To Role';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Contacts To Roles';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-contact_to_role-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'contacts_to_roles';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=createContactToRole';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildContactToRoleHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadContactToRole(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=loadContactToRole';
		}
...
function loadAllContactToRoleRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=loadAllContactToRoleRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateContactToRole(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterContactToRoleHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=updateContactToRole';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllContactToRoleAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=updateAllContactToRoleAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteContactToRole(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Contact To Role?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=deleteContactToRole';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveContactToRole(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts_to_roles-ajax.php?method=saveContactToRole';
		}
...
function buildContactToRoleHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterContactToRoleHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
