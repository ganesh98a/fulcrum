 ...
 */
function createContactCompany(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Contact Company';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Contact Companies';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-contact_company-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'contact_companies';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=createContactCompany';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildContactCompanyHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadContactCompany(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=loadContactCompany';
		}
...
function loadAllContactCompanyRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=loadAllContactCompanyRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateContactCompany(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterContactCompanyHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=updateContactCompany';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllContactCompanyAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=updateAllContactCompanyAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteContactCompany(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Contact Company?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=deleteContactCompany';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveContactCompany(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_companies-ajax.php?method=saveContactCompany';
		}
...
function buildContactCompanyHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		var user_user_company_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--user_user_company_id--' + uniqueId;
		if ($("#" + user_user_company_id_element_id).length) {
			var user_user_company_id = $("#" + user_user_company_id_element_id).val();
			user_user_company_id = parseInputToInt(user_user_company_id);
			ajaxQueryString = ajaxQueryString + '&user_user_company_id=' + encodeURIComponent(user_user_company_id);
		}

		var contact_user_company_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--contact_user_company_id--' + uniqueId;
		if ($("#" + contact_user_company_id_element_id).length) {
			var contact_user_company_id = $("#" + contact_user_company_id_element_id).val();
			contact_user_company_id = parseInputToInt(contact_user_company_id);
			ajaxQueryString = ajaxQueryString + '&contact_user_company_id=' + encodeURIComponent(contact_user_company_id);
		}

		var company_element_id = attributeGroupName + '--' + attributeSubgroupName + '--company--' + uniqueId;
		if ($("#" + company_element_id).length) {
			var company = $("#" + company_element_id).val();
			ajaxQueryString = ajaxQueryString + '&company=' + encodeURIComponent(company);
		}
		var primary_phone_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--primary_phone_number--' + uniqueId;
		...
		var employer_identification_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--employer_identification_number--' + uniqueId;
		if ($("#" + employer_identification_number_element_id).length) {
			var employer_identification_number = $("#" + employer_identification_number_element_id).val();
			ajaxQueryString = ajaxQueryString + '&employer_identification_number=' + encodeURIComponent(employer_identification_number);
		}
		...
		var construction_license_number_expiration_date_element_id = attributeGroupName + '--' + attributeSubgroupName + '--construction_license_number_expiration_date--' + uniqueId;
		if ($("#" + construction_license_number_expiration_date_element_id).length) {
			var construction_license_number_expiration_date = $("#" + construction_license_number_expiration_date_element_id).val();
			construction_license_number_expiration_date = convertDateToMySQLFormat(construction_license_number_expiration_date);
			ajaxQueryString = ajaxQueryString + '&construction_license_number_expiration_date=' + encodeURIComponent(construction_license_number_expiration_date);
		}
...
function filterContactCompanyHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	...
	switch (attributeName) {
		case 'contact_company_id':
			...
			inputDataFiltered = true;
			break;
		case 'user_user_company_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'contact_user_company_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'primary_phone_number':
			var newValue = parseInputToDigits(tmpValue);
			inputDataFiltered = true;
			break;
		case 'construction_license_number_expiration_date':
