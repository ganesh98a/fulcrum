 ...
 */
function createJobsiteOffsiteworkRegion(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Offsitework Region';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Offsitework Regions';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_offsitework_region-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_offsitework_regions';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=createJobsiteOffsiteworkRegion';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteOffsiteworkRegionHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteOffsiteworkRegion(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=loadJobsiteOffsiteworkRegion';
		}
		...
		var jobsite_offsitework_region_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_region_id--' + uniqueId;
		if ($("#" + jobsite_offsitework_region_id_element_id).length) {
			var jobsite_offsitework_region_id = $("#" + jobsite_offsitework_region_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_region_id=' + encodeURIComponent(jobsite_offsitework_region_id);
		}
...
function loadAllJobsiteOffsiteworkRegionRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=loadAllJobsiteOffsiteworkRegionRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteOffsiteworkRegion(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteOffsiteworkRegionHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=updateJobsiteOffsiteworkRegion';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteOffsiteworkRegionAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=updateAllJobsiteOffsiteworkRegionAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteOffsiteworkRegion(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Offsitework Region?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=deleteJobsiteOffsiteworkRegion';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteOffsiteworkRegion(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_regions-ajax.php?method=saveJobsiteOffsiteworkRegion';
		}
...
function buildJobsiteOffsiteworkRegionHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_offsitework_region_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_offsitework_region_id = parseInputToMySQLUnsignedInt(jobsite_offsitework_region_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_region_id=' + encodeURIComponent(jobsite_offsitework_region_id);
			}
		}
		...
		var jobsite_offsitework_region_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_region--' + uniqueId;
		if ($("#" + jobsite_offsitework_region_element_id).length) {
			var jobsite_offsitework_region = $("#" + jobsite_offsitework_region_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_region=' + encodeURIComponent(jobsite_offsitework_region);
		}
		var jobsite_offsitework_region_description_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_region_description--' + uniqueId;
		if ($("#" + jobsite_offsitework_region_description_element_id).length) {
			var jobsite_offsitework_region_description = $("#" + jobsite_offsitework_region_description_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_region_description=' + encodeURIComponent(jobsite_offsitework_region_description);
		}
...
function filterJobsiteOffsiteworkRegionHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_offsitework_region_id':
