 ...
 */
function createMobilePhoneNumber(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Mobile Phone Number';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Mobile Phone Numbers';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-mobile_phone_number-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'mobile_phone_numbers';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=createMobilePhoneNumber';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildMobilePhoneNumberHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadMobilePhoneNumber(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=loadMobilePhoneNumber';
		}
...
function loadAllMobilePhoneNumberRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=loadAllMobilePhoneNumberRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateMobilePhoneNumber(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterMobilePhoneNumberHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=updateMobilePhoneNumber';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllMobilePhoneNumberAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=updateAllMobilePhoneNumberAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteMobilePhoneNumber(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Mobile Phone Number?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=deleteMobilePhoneNumber';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveMobilePhoneNumber(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'mobile_phone_numbers-ajax.php?method=saveMobilePhoneNumber';
		}
...
function buildMobilePhoneNumberHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		var mobile_network_carrier_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--mobile_network_carrier_id--' + uniqueId;
		if ($("#" + mobile_network_carrier_id_element_id).length) {
			var mobile_network_carrier_id = $("#" + mobile_network_carrier_id_element_id).val();
			mobile_network_carrier_id = parseInputToInt(mobile_network_carrier_id);
			ajaxQueryString = ajaxQueryString + '&mobile_network_carrier_id=' + encodeURIComponent(mobile_network_carrier_id);
		}

		var verified_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--verified_flag--' + uniqueId;
		if ($("#" + verified_flag_element_id).length) {
			var verified_flag = $("#" + verified_flag_element_id).val();
			if ($("#" + verified_flag_element_id).is(':checkbox')) {
				if ($("#" + verified_flag_element_id).is(':checked')) {
					verified_flag = 'Y';
				} else {
					verified_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&verified_flag=' + encodeURIComponent(verified_flag);
		}
...
function filterMobilePhoneNumberHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	...
	switch (attributeName) {
		...
		case 'contact_phone_number_id':
			...
			inputDataFiltered = true;
			break;
		case 'mobile_network_carrier_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		default:
