 ...
 */
function createRequestForInformationDraftAttachment(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Request For Information Draft Attachment';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Request For Information Draft Attachments';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-request_for_information_draft_attachment-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'request_for_information_draft_attachments';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=createRequestForInformationDraftAttachment';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildRequestForInformationDraftAttachmentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadRequestForInformationDraftAttachment(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=loadRequestForInformationDraftAttachment';
		}
...
function loadAllRequestForInformationDraftAttachmentRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=loadAllRequestForInformationDraftAttachmentRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateRequestForInformationDraftAttachment(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterRequestForInformationDraftAttachmentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=updateRequestForInformationDraftAttachment';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllRequestForInformationDraftAttachmentAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=updateAllRequestForInformationDraftAttachmentAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteRequestForInformationDraftAttachment(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Request For Information Draft Attachment?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=deleteRequestForInformationDraftAttachment';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveRequestForInformationDraftAttachment(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_draft_attachments-ajax.php?method=saveRequestForInformationDraftAttachment';
		}
...
function buildRequestForInformationDraftAttachmentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterRequestForInformationDraftAttachmentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
