 ...
 */
function createChangeOrderDraftAttachment(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Draft Attachment';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Draft Attachments';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_draft_attachment-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_draft_attachments';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=createChangeOrderDraftAttachment';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderDraftAttachmentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderDraftAttachment(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=loadChangeOrderDraftAttachment';
		}
...
function loadAllChangeOrderDraftAttachmentRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=loadAllChangeOrderDraftAttachmentRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderDraftAttachment(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderDraftAttachmentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=updateChangeOrderDraftAttachment';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderDraftAttachmentAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=updateAllChangeOrderDraftAttachmentAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderDraftAttachment(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Draft Attachment?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=deleteChangeOrderDraftAttachment';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderDraftAttachment(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_draft_attachments-ajax.php?method=saveChangeOrderDraftAttachment';
		}
...
function buildChangeOrderDraftAttachmentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterChangeOrderDraftAttachmentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
