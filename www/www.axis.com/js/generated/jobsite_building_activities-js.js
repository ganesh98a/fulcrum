 ...
 */
function createJobsiteBuildingActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Building Activity';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Building Activities';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_building_activity-record';
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=createJobsiteBuildingActivity';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteBuildingActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
		...
		var returnedJqXHR = $.ajax({
			...
			success: createJobsiteBuildingActivitySuccess,
			error: errorHandler
		});
...
function createJobsiteBuildingActivitySuccess(data, textStatus, jqXHR)
{
	try {
		...
		messageAlert("Successfully Created", 'successMessage');
		...
		hideCreateJobsiteBuildingActivity();
		$("#divCreateJobsiteBuildingActivity").dialog('close');
...
function loadJobsiteBuildingActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=loadJobsiteBuildingActivity';
		}
		...
		var jobsite_building_activity_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_building_activity_id--' + uniqueId;
		if ($("#" + jobsite_building_activity_id_element_id).length) {
			var jobsite_building_activity_id = $("#" + jobsite_building_activity_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_building_activity_id=' + encodeURIComponent(jobsite_building_activity_id);
		}
...
function loadAllJobsiteBuildingActivityRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=loadAllJobsiteBuildingActivityRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteBuildingActivity(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteBuildingActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=updateJobsiteBuildingActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteBuildingActivityAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=updateAllJobsiteBuildingActivityAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteBuildingActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Building Activity?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=deleteJobsiteBuildingActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteBuildingActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activities-ajax.php?method=saveJobsiteBuildingActivity';
		}
...
function buildJobsiteBuildingActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_building_activity_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_building_activity_id = parseInputToMySQLUnsignedInt(jobsite_building_activity_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_building_activity_id=' + encodeURIComponent(jobsite_building_activity_id);
			}
		}
...
function filterJobsiteBuildingActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_building_activity_id':
