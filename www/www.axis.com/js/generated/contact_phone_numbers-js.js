 ...
 */
function createContactPhoneNumber(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Contact Phone Number';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Contact Phone Numbers';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-contact_phone_number-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'contact_phone_numbers';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=createContactPhoneNumber';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildContactPhoneNumberHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadContactPhoneNumber(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=loadContactPhoneNumber';
		}
		...
		var contact_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--contact_phone_number_id--' + uniqueId;
		if ($("#" + contact_phone_number_id_element_id).length) {
			var contact_phone_number_id = $("#" + contact_phone_number_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&contact_phone_number_id=' + encodeURIComponent(contact_phone_number_id);
		}
...
function loadAllContactPhoneNumberRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=loadAllContactPhoneNumberRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateContactPhoneNumber(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterContactPhoneNumberHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=updateContactPhoneNumber';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllContactPhoneNumberAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=updateAllContactPhoneNumberAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteContactPhoneNumber(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Contact Phone Number?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=deleteContactPhoneNumber';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveContactPhoneNumber(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_phone_numbers-ajax.php?method=saveContactPhoneNumber';
		}
...
function buildContactPhoneNumberHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + contact_phone_number_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					contact_phone_number_id = parseInputToMySQLUnsignedInt(contact_phone_number_id);
				}
				ajaxQueryString = ajaxQueryString + '&contact_phone_number_id=' + encodeURIComponent(contact_phone_number_id);
			}
		}
		...
		if ($("#" + contact_id_element_id).length) {
			...
			contact_id = parseInputToInt(contact_id);
...
function filterContactPhoneNumberHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'contact_phone_number_id':
