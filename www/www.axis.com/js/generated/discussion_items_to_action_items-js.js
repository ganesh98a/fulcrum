 ...
 */
function createDiscussionItemToActionItem(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Discussion Item To Action Item';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Discussion Items To Action Items';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-discussion_item_to_action_item-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'discussion_items_to_action_items';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=createDiscussionItemToActionItem';
		}
		var discussion_item_id 	= options.discussion_item_id;
		var styleMT = $("#record_list_container--action_items--discussion_item_id--"+discussion_item_id+" tr:last").attr('class');
		...
		var ajaxQueryString =
			...
			'&styleMT=' + encodeURIComponent(styleMT) +
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildDiscussionItemToActionItemHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadDiscussionItemToActionItem(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=loadDiscussionItemToActionItem';
		}
...
function loadAllDiscussionItemToActionItemRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=loadAllDiscussionItemToActionItemRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateDiscussionItemToActionItem(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterDiscussionItemToActionItemHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=updateDiscussionItemToActionItem';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllDiscussionItemToActionItemAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=updateAllDiscussionItemToActionItemAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteDiscussionItemToActionItem(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Discussion Item To Action Item?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=deleteDiscussionItemToActionItem';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveDiscussionItemToActionItem(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'discussion_items_to_action_items-ajax.php?method=saveDiscussionItemToActionItem';
		}
...
function buildDiscussionItemToActionItemHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + discussion_item_id_element_id).length) {
			var discussion_item_id = $("#" + discussion_item_id_element_id).val();
				if (!optionsObjectIsEmpty && options.filterId) {
					discussion_item_id = parseInputToMySQLUnsignedInt(discussion_item_id);
				}
			ajaxQueryString = ajaxQueryString + '&discussion_item_id=' + encodeURIComponent(discussion_item_id);
		}
...
function filterDiscussionItemToActionItemHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
