 ...
 */
function createCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Cost Code';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Cost Codes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-cost_code-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'cost_codes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=createCostCode';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=loadCostCode';
		}
...
function loadAllCostCodeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=loadAllCostCodeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateCostCode(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=updateCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllCostCodeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=updateAllCostCodeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Cost Code?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=deleteCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_codes-ajax.php?method=saveCostCode';
		}
...
function buildCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		var cost_code_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code--' + uniqueId;
		if ($("#" + cost_code_element_id).length) {
			var cost_code = $("#" + cost_code_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code=' + encodeURIComponent(cost_code);
		}
		var cost_code_description_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_description--' + uniqueId;
		if ($("#" + cost_code_description_element_id).length) {
			var cost_code_description = $("#" + cost_code_description_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_description=' + encodeURIComponent(cost_code_description);
		}
		var cost_code_description_abbreviation_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_description_abbreviation--' + uniqueId;
		if ($("#" + cost_code_description_abbreviation_element_id).length) {
			var cost_code_description_abbreviation = $("#" + cost_code_description_abbreviation_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_description_abbreviation=' + encodeURIComponent(cost_code_description_abbreviation);
		}
...
function filterCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
