 ...
 */
function createContactCompanyOffice(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Contact Company Office';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Contact Company Offices';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-contact_company_office-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'contact_company_offices';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=createContactCompanyOffice';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildContactCompanyOfficeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadContactCompanyOffice(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=loadContactCompanyOffice';
		}
...
function loadAllContactCompanyOfficeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=loadAllContactCompanyOfficeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateContactCompanyOffice(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterContactCompanyOfficeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=updateContactCompanyOffice';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllContactCompanyOfficeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=updateAllContactCompanyOfficeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteContactCompanyOffice(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Contact Company Office?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=deleteContactCompanyOffice';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveContactCompanyOffice(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contact_company_offices-ajax.php?method=saveContactCompanyOffice';
		}
...
function buildContactCompanyOfficeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + contact_company_office_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					contact_company_office_id = parseInputToMySQLUnsignedInt(contact_company_office_id);
				}
				ajaxQueryString = ajaxQueryString + '&contact_company_office_id=' + encodeURIComponent(contact_company_office_id);
			}
		}
		...
		var office_nickname_element_id = attributeGroupName + '--' + attributeSubgroupName + '--office_nickname--' + uniqueId;
		if ($("#" + office_nickname_element_id).length) {
			var office_nickname = $("#" + office_nickname_element_id).val();
			ajaxQueryString = ajaxQueryString + '&office_nickname=' + encodeURIComponent(office_nickname);
		}
		...
		if ($("#" + address_line_1_element_id).length) {
			$("#" + address_line_1_element_id).keyup(function() {
				$("#" + address_line_1_element_id).removeClass('redBorderThick');
			});
			var address_line_1 = $("#" + address_line_1_element_id).val();
			if(address_line_1 =='')
			{
				$("#" + address_line_1_element_id).addClass('redBorderThick');
				return false;
			}else
			{
				$("#" + address_line_1_element_id).removeClass('redBorderThick');
		...
		if ($("#" + address_city_element_id).length) {
			$("#" + address_city_element_id).keyup(function() {
				$("#" + address_city_element_id).removeClass('redBorderThick');
			});
			var address_city = $("#" + address_city_element_id).val();
			if(address_city =='')
			{
				$("#" + address_city_element_id).addClass('redBorderThick');
				return false;
			}else
			{
			$("#" + address_city_element_id).removeClass('redBorderThick');
		...
		if ($("#" + address_state_or_region_element_id).length) {
			$("#" + address_state_or_region_element_id).keyup(function() {
				$("#" + address_state_or_region_element_id).removeClass('redBorderThick');
			});
			var address_state_or_region = $("#" + address_state_or_region_element_id).val();
			if(address_state_or_region =='')
			{
				$("#" + address_state_or_region_element_id).addClass('redBorderThick');
				return false;
			}else
			{
				$("#" + address_state_or_region_element_id).removeClass('redBorderThick');
		...
		var head_quarters_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--head_quarters_flag--' + uniqueId;
		if ($("#" + head_quarters_flag_element_id).length) {
			var head_quarters_flag = $("#" + head_quarters_flag_element_id).val();
			if ($("#" + head_quarters_flag_element_id).is(':checkbox')) {
				if ($("#" + head_quarters_flag_element_id).is(':checked')) {
					head_quarters_flag = 'Y';
				} else {
					head_quarters_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&head_quarters_flag=' + encodeURIComponent(head_quarters_flag);
		}
		var address_validated_by_user_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--address_validated_by_user_flag--' + uniqueId;
		if ($("#" + address_validated_by_user_flag_element_id).length) {
			var address_validated_by_user_flag = $("#" + address_validated_by_user_flag_element_id).val();
			if ($("#" + address_validated_by_user_flag_element_id).is(':checkbox')) {
				if ($("#" + address_validated_by_user_flag_element_id).is(':checked')) {
					address_validated_by_user_flag = 'Y';
				} else {
					address_validated_by_user_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&address_validated_by_user_flag=' + encodeURIComponent(address_validated_by_user_flag);
		}
		var address_validated_by_web_service_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--address_validated_by_web_service_flag--' + uniqueId;
		if ($("#" + address_validated_by_web_service_flag_element_id).length) {
			var address_validated_by_web_service_flag = $("#" + address_validated_by_web_service_flag_element_id).val();
			if ($("#" + address_validated_by_web_service_flag_element_id).is(':checkbox')) {
				if ($("#" + address_validated_by_web_service_flag_element_id).is(':checked')) {
					address_validated_by_web_service_flag = 'Y';
				} else {
					address_validated_by_web_service_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&address_validated_by_web_service_flag=' + encodeURIComponent(address_validated_by_web_service_flag);
		}
		var address_validation_by_web_service_error_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--address_validation_by_web_service_error_flag--' + uniqueId;
		if ($("#" + address_validation_by_web_service_error_flag_element_id).length) {
			var address_validation_by_web_service_error_flag = $("#" + address_validation_by_web_service_error_flag_element_id).val();
			if ($("#" + address_validation_by_web_service_error_flag_element_id).is(':checkbox')) {
				if ($("#" + address_validation_by_web_service_error_flag_element_id).is(':checked')) {
					address_validation_by_web_service_error_flag = 'Y';
				} else {
					address_validation_by_web_service_error_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&address_validation_by_web_service_error_flag=' + encodeURIComponent(address_validation_by_web_service_error_flag);
		}
...
function filterContactCompanyOfficeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
