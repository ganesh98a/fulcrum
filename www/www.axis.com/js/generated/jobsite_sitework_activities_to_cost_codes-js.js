 ...
 */
function createJobsiteSiteworkActivityToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Sitework Activity To Cost Code';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Sitework Activities To Cost Codes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_sitework_activity_to_cost_code-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_sitework_activities_to_cost_codes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=createJobsiteSiteworkActivityToCostCode';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteSiteworkActivityToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteSiteworkActivityToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=loadJobsiteSiteworkActivityToCostCode';
		}
...
function loadAllJobsiteSiteworkActivityToCostCodeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=loadAllJobsiteSiteworkActivityToCostCodeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteSiteworkActivityToCostCode(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteSiteworkActivityToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=updateJobsiteSiteworkActivityToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteSiteworkActivityToCostCodeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=updateAllJobsiteSiteworkActivityToCostCodeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteSiteworkActivityToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Sitework Activity To Cost Code?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=deleteJobsiteSiteworkActivityToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteSiteworkActivityToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activities_to_cost_codes-ajax.php?method=saveJobsiteSiteworkActivityToCostCode';
		}
...
function buildJobsiteSiteworkActivityToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterJobsiteSiteworkActivityToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
