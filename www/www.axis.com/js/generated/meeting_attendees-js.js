 ...
 */
function createMeetingAttendee(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Meeting Attendee';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Meeting Attendees';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-meeting_attendee-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'meeting_attendees';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=createMeetingAttendee';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildMeetingAttendeeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadMeetingAttendee(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=loadMeetingAttendee';
		}
		...
		var meeting_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--meeting_id--' + uniqueId;
...
function loadAllMeetingAttendeeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=loadAllMeetingAttendeeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateMeetingAttendee(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterMeetingAttendeeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=updateMeetingAttendee';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllMeetingAttendeeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=updateAllMeetingAttendeeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteMeetingAttendee(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Meeting Attendee?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=deleteMeetingAttendee';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveMeetingAttendee(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_attendees-ajax.php?method=saveMeetingAttendee';
		}
...
function buildMeetingAttendeeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + meeting_id_element_id).length) {
			var meeting_id = $("#" + meeting_id_element_id).val();
				if (!optionsObjectIsEmpty && options.filterId) {
					meeting_id = parseInputToMySQLUnsignedInt(meeting_id);
				}
			ajaxQueryString = ajaxQueryString + '&meeting_id=' + encodeURIComponent(meeting_id);
		}
...
function filterMeetingAttendeeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
