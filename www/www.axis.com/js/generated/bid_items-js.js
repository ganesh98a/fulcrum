 ...
 */
function createBidItem(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Bid Item';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Bid Items';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-bid_item-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'bid_items';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'bid_items-ajax.php?method=createBidItem';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildBidItemHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadBidItem(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=loadBidItem';
		}
...
function loadAllBidItemRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=loadAllBidItemRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateBidItem(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterBidItemHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=updateBidItem';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllBidItemAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=updateAllBidItemAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteBidItem(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Bid Item?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=deleteBidItem';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveBidItem(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'bid_items-ajax.php?method=saveBidItem';
		}
...
function buildBidItemHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + bid_item_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					bid_item_id = parseInputToMySQLUnsignedInt(bid_item_id);
				}
				ajaxQueryString = ajaxQueryString + '&bid_item_id=' + encodeURIComponent(bid_item_id);
			}
		}
		...
		var bid_item_element_id = attributeGroupName + '--' + attributeSubgroupName + '--bid_item--' + uniqueId;
		if ($("#" + bid_item_element_id).length) {
			var bid_item = $("#" + bid_item_element_id).val();
			ajaxQueryString = ajaxQueryString + '&bid_item=' + encodeURIComponent(bid_item);
		}
...
function filterBidItemHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
