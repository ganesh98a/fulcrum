 ...
 */
function createScBidItemToSubcontractorBid(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Sc Bid Item To Subcontractor Bid';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Sc Bid Items To Subcontractor Bids';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-sc_bid_item_to_subcontractor_bid-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'sc_bid_items_to_subcontractor_bids';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=createScBidItemToSubcontractorBid';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildScBidItemToSubcontractorBidHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadScBidItemToSubcontractorBid(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=loadScBidItemToSubcontractorBid';
		}
		...
		var sc_bid_item_to_subcontractor_bid_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--sc_bid_item_to_subcontractor_bid_id--' + uniqueId;
		if ($("#" + sc_bid_item_to_subcontractor_bid_id_element_id).length) {
			var sc_bid_item_to_subcontractor_bid_id = $("#" + sc_bid_item_to_subcontractor_bid_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&sc_bid_item_to_subcontractor_bid_id=' + encodeURIComponent(sc_bid_item_to_subcontractor_bid_id);
		}
...
function loadAllScBidItemToSubcontractorBidRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=loadAllScBidItemToSubcontractorBidRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateScBidItemToSubcontractorBid(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterScBidItemToSubcontractorBidHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=updateScBidItemToSubcontractorBid';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllScBidItemToSubcontractorBidAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=updateAllScBidItemToSubcontractorBidAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteScBidItemToSubcontractorBid(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Sc Bid Item To Subcontractor Bid?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=deleteScBidItemToSubcontractorBid';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveScBidItemToSubcontractorBid(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'sc_bid_items_to_subcontractor_bids-ajax.php?method=saveScBidItemToSubcontractorBid';
		}
...
function buildScBidItemToSubcontractorBidHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + sc_bid_item_to_subcontractor_bid_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					sc_bid_item_to_subcontractor_bid_id = parseInputToMySQLUnsignedInt(sc_bid_item_to_subcontractor_bid_id);
				}
				ajaxQueryString = ajaxQueryString + '&sc_bid_item_to_subcontractor_bid_id=' + encodeURIComponent(sc_bid_item_to_subcontractor_bid_id);
			}
		}
		...
		if ($("#" + sc_bid_item_id_element_id).length) {
			...
			sc_bid_item_id = parseInputToInt(sc_bid_item_id);
...
function filterScBidItemToSubcontractorBidHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'sc_bid_item_to_subcontractor_bid_id':
