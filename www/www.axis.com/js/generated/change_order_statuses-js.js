 ...
 */
function createChangeOrderStatus(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Status';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Statuses';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_status-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_statuses';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=createChangeOrderStatus';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderStatusHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderStatus(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=loadChangeOrderStatus';
		}
...
function loadAllChangeOrderStatusRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=loadAllChangeOrderStatusRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderStatus(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderStatusHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=updateChangeOrderStatus';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderStatusAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=updateAllChangeOrderStatusAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderStatus(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Status?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=deleteChangeOrderStatus';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderStatus(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_statuses-ajax.php?method=saveChangeOrderStatus';
		}
...
function buildChangeOrderStatusHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + change_order_status_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					change_order_status_id = parseInputToMySQLUnsignedInt(change_order_status_id);
				}
				ajaxQueryString = ajaxQueryString + '&change_order_status_id=' + encodeURIComponent(change_order_status_id);
			}
		}

		var change_order_status_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_status--' + uniqueId;
		if ($("#" + change_order_status_element_id).length) {
			var change_order_status = $("#" + change_order_status_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_status=' + encodeURIComponent(change_order_status);
		}
...
function filterChangeOrderStatusHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
