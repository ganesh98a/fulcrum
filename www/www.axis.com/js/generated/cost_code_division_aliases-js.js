 ...
 */
function createCostCodeDivisionAlias(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Cost Code Division Alias';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Cost Code Division Aliases';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-cost_code_division_alias-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'cost_code_division_aliases';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=createCostCodeDivisionAlias';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildCostCodeDivisionAliasHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadCostCodeDivisionAlias(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=loadCostCodeDivisionAlias';
		}
		...
		var cost_code_division_alias_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_division_alias_id--' + uniqueId;
		if ($("#" + cost_code_division_alias_id_element_id).length) {
			var cost_code_division_alias_id = $("#" + cost_code_division_alias_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_division_alias_id=' + encodeURIComponent(cost_code_division_alias_id);
		}
...
function loadAllCostCodeDivisionAliasRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=loadAllCostCodeDivisionAliasRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateCostCodeDivisionAlias(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterCostCodeDivisionAliasHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=updateCostCodeDivisionAlias';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllCostCodeDivisionAliasAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=updateAllCostCodeDivisionAliasAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteCostCodeDivisionAlias(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Cost Code Division Alias?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=deleteCostCodeDivisionAlias';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveCostCodeDivisionAlias(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_division_aliases-ajax.php?method=saveCostCodeDivisionAlias';
		}
...
function buildCostCodeDivisionAliasHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + cost_code_division_alias_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					cost_code_division_alias_id = parseInputToMySQLUnsignedInt(cost_code_division_alias_id);
				}
				ajaxQueryString = ajaxQueryString + '&cost_code_division_alias_id=' + encodeURIComponent(cost_code_division_alias_id);
			}
		}
		...
		if ($("#" + cost_code_division_id_element_id).length) {
			...
			cost_code_division_id = parseInputToInt(cost_code_division_id);
		...
		if ($("#" + contact_company_id_element_id).length) {
			...
			contact_company_id = parseInputToInt(contact_company_id);
			ajaxQueryString = ajaxQueryString + '&contact_company_id=' + encodeURIComponent(contact_company_id);
		}

		var division_number_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--division_number_alias--' + uniqueId;
		if ($("#" + division_number_alias_element_id).length) {
			var division_number_alias = $("#" + division_number_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&division_number_alias=' + encodeURIComponent(division_number_alias);
		}
		var division_code_heading_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--division_code_heading_alias--' + uniqueId;
		if ($("#" + division_code_heading_alias_element_id).length) {
			var division_code_heading_alias = $("#" + division_code_heading_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&division_code_heading_alias=' + encodeURIComponent(division_code_heading_alias);
		}
		var division_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--division_alias--' + uniqueId;
		if ($("#" + division_alias_element_id).length) {
			var division_alias = $("#" + division_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&division_alias=' + encodeURIComponent(division_alias);
		}
		var division_abbreviation_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--division_abbreviation_alias--' + uniqueId;
		if ($("#" + division_abbreviation_alias_element_id).length) {
			var division_abbreviation_alias = $("#" + division_abbreviation_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&division_abbreviation_alias=' + encodeURIComponent(division_abbreviation_alias);
		}
...
function filterCostCodeDivisionAliasHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
