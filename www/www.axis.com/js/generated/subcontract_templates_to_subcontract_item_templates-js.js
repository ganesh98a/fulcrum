 ...
 */
function createSubcontractTemplateToSubcontractItemTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Subcontract Template To Subcontract Item Template';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Subcontract Templates To Subcontract Item Templates';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-subcontract_template_to_subcontract_item_template-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'subcontract_templates_to_subcontract_item_templates';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=createSubcontractTemplateToSubcontractItemTemplate';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildSubcontractTemplateToSubcontractItemTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadSubcontractTemplateToSubcontractItemTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=loadSubcontractTemplateToSubcontractItemTemplate';
		}
...
function loadAllSubcontractTemplateToSubcontractItemTemplateRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=loadAllSubcontractTemplateToSubcontractItemTemplateRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateSubcontractTemplateToSubcontractItemTemplate(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterSubcontractTemplateToSubcontractItemTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=updateSubcontractTemplateToSubcontractItemTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllSubcontractTemplateToSubcontractItemTemplateAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=updateAllSubcontractTemplateToSubcontractItemTemplateAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteSubcontractTemplateToSubcontractItemTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Subcontract Template To Subcontract Item Template?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=deleteSubcontractTemplateToSubcontractItemTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveSubcontractTemplateToSubcontractItemTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'subcontract_templates_to_subcontract_item_templates-ajax.php?method=saveSubcontractTemplateToSubcontractItemTemplate';
		}
...
function buildSubcontractTemplateToSubcontractItemTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + subcontract_template_id_element_id).length) {
			var subcontract_template_id = $("#" + subcontract_template_id_element_id).val();
				if (!optionsObjectIsEmpty && options.filterId) {
					subcontract_template_id = parseInputToMySQLUnsignedInt(subcontract_template_id);
				}
			ajaxQueryString = ajaxQueryString + '&subcontract_template_id=' + encodeURIComponent(subcontract_template_id);
		}
		...
		if ($("#" + subcontract_item_template_id_element_id).length) {
			var subcontract_item_template_id = $("#" + subcontract_item_template_id_element_id).val();
				if (!optionsObjectIsEmpty && options.filterId) {
					subcontract_item_template_id = parseInputToMySQLUnsignedInt(subcontract_item_template_id);
				}
			ajaxQueryString = ajaxQueryString + '&subcontract_item_template_id=' + encodeURIComponent(subcontract_item_template_id);
		}
...
function filterSubcontractTemplateToSubcontractItemTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
