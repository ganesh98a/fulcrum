 ...
 */
function createJobsiteBuilding(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Building';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Buildings';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_building-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_buildings';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=createJobsiteBuilding';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteBuildingHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteBuilding(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=loadJobsiteBuilding';
		}
...
function loadAllJobsiteBuildingRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=loadAllJobsiteBuildingRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteBuilding(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteBuildingHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=updateJobsiteBuilding';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteBuildingAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=updateAllJobsiteBuildingAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteBuilding(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Building?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=deleteJobsiteBuilding';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteBuilding(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_buildings-ajax.php?method=saveJobsiteBuilding';
		}
...
function buildJobsiteBuildingHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_building_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_building_id = parseInputToMySQLUnsignedInt(jobsite_building_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_building_id=' + encodeURIComponent(jobsite_building_id);
			}
		}
		...
		var jobsite_building_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_building--' + uniqueId;
		if ($("#" + jobsite_building_element_id).length) {
			var jobsite_building = $("#" + jobsite_building_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_building=' + encodeURIComponent(jobsite_building);
		}
		var jobsite_building_description_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_building_description--' + uniqueId;
		if ($("#" + jobsite_building_description_element_id).length) {
			var jobsite_building_description = $("#" + jobsite_building_description_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_building_description=' + encodeURIComponent(jobsite_building_description);
		}
...
function filterJobsiteBuildingHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
