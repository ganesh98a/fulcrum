 ...
 */
function createMeetingLocation(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Meeting Location';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Meeting Locations';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-meeting_location-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'meeting_locations';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=createMeetingLocation';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildMeetingLocationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadMeetingLocation(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=loadMeetingLocation';
		}
...
function loadAllMeetingLocationRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=loadAllMeetingLocationRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateMeetingLocation(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterMeetingLocationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=updateMeetingLocation';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllMeetingLocationAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=updateAllMeetingLocationAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteMeetingLocation(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Meeting Location?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=deleteMeetingLocation';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveMeetingLocation(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'meeting_locations-ajax.php?method=saveMeetingLocation';
		}
...
function buildMeetingLocationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + meeting_location_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					meeting_location_id = parseInputToMySQLUnsignedInt(meeting_location_id);
				}
				ajaxQueryString = ajaxQueryString + '&meeting_location_id=' + encodeURIComponent(meeting_location_id);
			}
		}
		...
		var meeting_location_element_id = attributeGroupName + '--' + attributeSubgroupName + '--meeting_location--' + uniqueId;
		if ($("#" + meeting_location_element_id).length) {
			var meeting_location = $("#" + meeting_location_element_id).val();
			ajaxQueryString = ajaxQueryString + '&meeting_location=' + encodeURIComponent(meeting_location);
		}
		var meeting_location_abbreviation_element_id = attributeGroupName + '--' + attributeSubgroupName + '--meeting_location_abbreviation--' + uniqueId;
		if ($("#" + meeting_location_abbreviation_element_id).length) {
			var meeting_location_abbreviation = $("#" + meeting_location_abbreviation_element_id).val();
			ajaxQueryString = ajaxQueryString + '&meeting_location_abbreviation=' + encodeURIComponent(meeting_location_abbreviation);
		}
...
function filterMeetingLocationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
