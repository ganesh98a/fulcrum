 ...
 */
function createJobsiteBuildingActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Building Activity Template To Cost Code';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Building Activity Templates To Cost Codes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_building_activity_template_to_cost_code-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_building_activity_templates_to_cost_codes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=createJobsiteBuildingActivityTemplateToCostCode';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteBuildingActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteBuildingActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=loadJobsiteBuildingActivityTemplateToCostCode';
		}
...
function loadAllJobsiteBuildingActivityTemplateToCostCodeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=loadAllJobsiteBuildingActivityTemplateToCostCodeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteBuildingActivityTemplateToCostCode(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteBuildingActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=updateJobsiteBuildingActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteBuildingActivityTemplateToCostCodeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=updateAllJobsiteBuildingActivityTemplateToCostCodeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteBuildingActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Building Activity Template To Cost Code?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=deleteJobsiteBuildingActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteBuildingActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates_to_cost_codes-ajax.php?method=saveJobsiteBuildingActivityTemplateToCostCode';
		}
...
function buildJobsiteBuildingActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterJobsiteBuildingActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
