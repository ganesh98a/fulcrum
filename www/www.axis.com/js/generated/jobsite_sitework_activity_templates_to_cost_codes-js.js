 ...
 */
function createJobsiteSiteworkActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Sitework Activity Template To Cost Code';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Sitework Activity Templates To Cost Codes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_sitework_activity_template_to_cost_code-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_sitework_activity_templates_to_cost_codes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=createJobsiteSiteworkActivityTemplateToCostCode';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteSiteworkActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteSiteworkActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=loadJobsiteSiteworkActivityTemplateToCostCode';
		}
		...
		var jobsite_sitework_activity_template_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_sitework_activity_template_id--' + uniqueId;
		if ($("#" + jobsite_sitework_activity_template_id_element_id).length) {
			var jobsite_sitework_activity_template_id = $("#" + jobsite_sitework_activity_template_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_activity_template_id=' + encodeURIComponent(jobsite_sitework_activity_template_id);
		}
...
function loadAllJobsiteSiteworkActivityTemplateToCostCodeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=loadAllJobsiteSiteworkActivityTemplateToCostCodeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteSiteworkActivityTemplateToCostCode(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteSiteworkActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=updateJobsiteSiteworkActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteSiteworkActivityTemplateToCostCodeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=updateAllJobsiteSiteworkActivityTemplateToCostCodeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteSiteworkActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Sitework Activity Template To Cost Code?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=deleteJobsiteSiteworkActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteSiteworkActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_activity_templates_to_cost_codes-ajax.php?method=saveJobsiteSiteworkActivityTemplateToCostCode';
		}
...
function buildJobsiteSiteworkActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + jobsite_sitework_activity_template_id_element_id).length) {
			var jobsite_sitework_activity_template_id = $("#" + jobsite_sitework_activity_template_id_element_id).val();
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_sitework_activity_template_id = parseInputToMySQLUnsignedInt(jobsite_sitework_activity_template_id);
				}
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_activity_template_id=' + encodeURIComponent(jobsite_sitework_activity_template_id);
		}
...
function filterJobsiteSiteworkActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_sitework_activity_template_id':
