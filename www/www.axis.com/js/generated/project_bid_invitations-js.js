 ...
 */
function createProjectBidInvitation(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Project Bid Invitation';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Project Bid Invitations';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-project_bid_invitation-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'project_bid_invitations';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=createProjectBidInvitation';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildProjectBidInvitationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadProjectBidInvitation(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=loadProjectBidInvitation';
		}
		...
		var project_bid_invitation_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--project_bid_invitation_id--' + uniqueId;
		if ($("#" + project_bid_invitation_id_element_id).length) {
			var project_bid_invitation_id = $("#" + project_bid_invitation_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&project_bid_invitation_id=' + encodeURIComponent(project_bid_invitation_id);
		}
...
function loadAllProjectBidInvitationRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=loadAllProjectBidInvitationRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateProjectBidInvitation(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterProjectBidInvitationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=updateProjectBidInvitation';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllProjectBidInvitationAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=updateAllProjectBidInvitationAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteProjectBidInvitation(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Project Bid Invitation?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=deleteProjectBidInvitation';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveProjectBidInvitation(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'project_bid_invitations-ajax.php?method=saveProjectBidInvitation';
		}
...
function buildProjectBidInvitationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + project_bid_invitation_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					project_bid_invitation_id = parseInputToMySQLUnsignedInt(project_bid_invitation_id);
				}
				ajaxQueryString = ajaxQueryString + '&project_bid_invitation_id=' + encodeURIComponent(project_bid_invitation_id);
			}
		}
		...
		var project_bid_invitation_sequence_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--project_bid_invitation_sequence_number--' + uniqueId;
		if ($("#" + project_bid_invitation_sequence_number_element_id).length) {
			var project_bid_invitation_sequence_number = $("#" + project_bid_invitation_sequence_number_element_id).val();
			project_bid_invitation_sequence_number = parseInputToInt(project_bid_invitation_sequence_number);
			ajaxQueryString = ajaxQueryString + '&project_bid_invitation_sequence_number=' + encodeURIComponent(project_bid_invitation_sequence_number);
		}
		var project_bid_invitation_file_manager_file_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--project_bid_invitation_file_manager_file_id--' + uniqueId;
		if ($("#" + project_bid_invitation_file_manager_file_id_element_id).length) {
			var project_bid_invitation_file_manager_file_id = $("#" + project_bid_invitation_file_manager_file_id_element_id).val();
			project_bid_invitation_file_manager_file_id = parseInputToInt(project_bid_invitation_file_manager_file_id);
			ajaxQueryString = ajaxQueryString + '&project_bid_invitation_file_manager_file_id=' + encodeURIComponent(project_bid_invitation_file_manager_file_id);
		}
...
function filterProjectBidInvitationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'project_bid_invitation_id':
		...
		case 'project_id':
			...
			inputDataFiltered = true;
			break;
		case 'project_bid_invitation_sequence_number':
			var newValue = parseInputToMySQLUnsignedSmallInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'project_bid_invitation_file_manager_file_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'created':
