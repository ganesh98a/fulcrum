 ...
 */
function createJobsiteNote(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Note';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Notes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_note-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_notes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=createJobsiteNote';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteNoteHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteNote(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=loadJobsiteNote';
		}
		...
		var jobsite_note_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_note_id--' + uniqueId;
		if ($("#" + jobsite_note_id_element_id).length) {
			var jobsite_note_id = $("#" + jobsite_note_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_note_id=' + encodeURIComponent(jobsite_note_id);
		}
...
function loadAllJobsiteNoteRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=loadAllJobsiteNoteRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteNote(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteNoteHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=updateJobsiteNote';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteNoteAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=updateAllJobsiteNoteAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteNote(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Note?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=deleteJobsiteNote';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteNote(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_notes-ajax.php?method=saveJobsiteNote';
		}
...
function buildJobsiteNoteHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_note_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_note_id = parseInputToMySQLUnsignedInt(jobsite_note_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_note_id=' + encodeURIComponent(jobsite_note_id);
			}
		}
		...
		var jobsite_note_type_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_note_type_id--' + uniqueId;
		if ($("#" + jobsite_note_type_id_element_id).length) {
			var jobsite_note_type_id = $("#" + jobsite_note_type_id_element_id).val();
			jobsite_note_type_id = parseInputToInt(jobsite_note_type_id);
			ajaxQueryString = ajaxQueryString + '&jobsite_note_type_id=' + encodeURIComponent(jobsite_note_type_id);
		}

		var jobsite_note_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_note--' + uniqueId;
		if ($("#" + jobsite_note_element_id).length) {
			var jobsite_note = $("#" + jobsite_note_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_note=' + encodeURIComponent(jobsite_note);
		}
...
function filterJobsiteNoteHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_note_id':
