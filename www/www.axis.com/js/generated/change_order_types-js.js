 ...
 */
function createChangeOrderType(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Type';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Types';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_type-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_types';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=createChangeOrderType';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderTypeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderType(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=loadChangeOrderType';
		}
...
function loadAllChangeOrderTypeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=loadAllChangeOrderTypeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderType(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderTypeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=updateChangeOrderType';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderTypeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=updateAllChangeOrderTypeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderType(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Type?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=deleteChangeOrderType';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderType(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_types-ajax.php?method=saveChangeOrderType';
		}
...
function buildChangeOrderTypeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + change_order_type_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					change_order_type_id = parseInputToMySQLUnsignedInt(change_order_type_id);
				}
				ajaxQueryString = ajaxQueryString + '&change_order_type_id=' + encodeURIComponent(change_order_type_id);
			}
		}

		var change_order_type_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_type--' + uniqueId;
		if ($("#" + change_order_type_element_id).length) {
			var change_order_type = $("#" + change_order_type_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_type=' + encodeURIComponent(change_order_type);
		}
...
function filterChangeOrderTypeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
