 ...
 */
function createRequestForInformationNotification(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Request For Information Notification';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Request For Information Notifications';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-request_for_information_notification-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'request_for_information_notifications';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=createRequestForInformationNotification';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildRequestForInformationNotificationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadRequestForInformationNotification(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=loadRequestForInformationNotification';
		}
...
function loadAllRequestForInformationNotificationRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=loadAllRequestForInformationNotificationRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateRequestForInformationNotification(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterRequestForInformationNotificationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=updateRequestForInformationNotification';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllRequestForInformationNotificationAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=updateAllRequestForInformationNotificationAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteRequestForInformationNotification(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Request For Information Notification?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=deleteRequestForInformationNotification';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveRequestForInformationNotification(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'request_for_information_notifications-ajax.php?method=saveRequestForInformationNotification';
		}
...
function buildRequestForInformationNotificationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + request_for_information_id_element_id).length) {
			...
			request_for_information_id = parseInputToInt(request_for_information_id);
			ajaxQueryString = ajaxQueryString + '&request_for_information_id=' + encodeURIComponent(request_for_information_id);
		}

		var request_for_information_notification_timestamp_element_id = attributeGroupName + '--' + attributeSubgroupName + '--request_for_information_notification_timestamp--' + uniqueId;
		if ($("#" + request_for_information_notification_timestamp_element_id).length) {
			var request_for_information_notification_timestamp = $("#" + request_for_information_notification_timestamp_element_id).val();
			request_for_information_notification_timestamp = convertTimestampToMySQLFormat(request_for_information_notification_timestamp);
			ajaxQueryString = ajaxQueryString + '&request_for_information_notification_timestamp=' + encodeURIComponent(request_for_information_notification_timestamp);
		}
...
function filterRequestForInformationNotificationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	...
	switch (attributeName) {
		...
		case 'request_for_information_id':
			...
			inputDataFiltered = true;
			break;
		case 'request_for_information_notification_timestamp':
