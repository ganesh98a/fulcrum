 ...
 */
function createChangeOrderDistributionMethod(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Distribution Method';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Distribution Methods';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_distribution_method-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_distribution_methods';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=createChangeOrderDistributionMethod';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderDistributionMethodHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderDistributionMethod(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=loadChangeOrderDistributionMethod';
		}
		...
		var change_order_distribution_method_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_distribution_method_id--' + uniqueId;
		if ($("#" + change_order_distribution_method_id_element_id).length) {
			var change_order_distribution_method_id = $("#" + change_order_distribution_method_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_distribution_method_id=' + encodeURIComponent(change_order_distribution_method_id);
		}
...
function loadAllChangeOrderDistributionMethodRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=loadAllChangeOrderDistributionMethodRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderDistributionMethod(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderDistributionMethodHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=updateChangeOrderDistributionMethod';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderDistributionMethodAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=updateAllChangeOrderDistributionMethodAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderDistributionMethod(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Distribution Method?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=deleteChangeOrderDistributionMethod';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderDistributionMethod(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_distribution_methods-ajax.php?method=saveChangeOrderDistributionMethod';
		}
...
function buildChangeOrderDistributionMethodHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + change_order_distribution_method_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					change_order_distribution_method_id = parseInputToMySQLUnsignedInt(change_order_distribution_method_id);
				}
				ajaxQueryString = ajaxQueryString + '&change_order_distribution_method_id=' + encodeURIComponent(change_order_distribution_method_id);
			}
		}

		var change_order_distribution_method_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_distribution_method--' + uniqueId;
		if ($("#" + change_order_distribution_method_element_id).length) {
			var change_order_distribution_method = $("#" + change_order_distribution_method_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_distribution_method=' + encodeURIComponent(change_order_distribution_method);
		}
...
function filterChangeOrderDistributionMethodHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'change_order_distribution_method_id':
