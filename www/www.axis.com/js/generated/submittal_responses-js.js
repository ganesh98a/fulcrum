 ...
 */
function createSubmittalResponse(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Submittal Response';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Submittal Responses';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-submittal_response-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'submittal_responses';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=createSubmittalResponse';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var submittal_response_element_id = attributeGroupName + '--submittal_responses' + '--submittal_response--' + uniqueId;
		if ($("#" + submittal_response_element_id).length) {
			$("#" + submittal_response_element_id).keyup(function() {
				$("#" + submittal_response_element_id).removeClass('redBorderThick');
			});
			var submittal_response = $("#" + submittal_response_element_id).val();
			submittal_response=submittal_response.trim();
			if(submittal_response == "")
			{
				$("#" + submittal_response_element_id).addClass('redBorderThick');
				//To enable the buttons
				$("#Submittals__createSuResponseAndSendEmailViaPromiseChain").removeAttr('disabled');
				$("#Submittals__createSuResponseViaPromiseChain").removeAttr('disabled');
				return false;
			}else
			{
				$("#" + submittal_response_element_id).removeClass('redBorderThick');
			...
			var htmlRecordAttributesAsAjaxQueryString = buildSubmittalResponseHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadSubmittalResponse(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=loadSubmittalResponse';
		}
		...
		var submittal_response_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--submittal_response_id--' + uniqueId;
		if ($("#" + submittal_response_id_element_id).length) {
			var submittal_response_id = $("#" + submittal_response_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&submittal_response_id=' + encodeURIComponent(submittal_response_id);
		}
...
function loadAllSubmittalResponseRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=loadAllSubmittalResponseRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateSubmittalResponse(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterSubmittalResponseHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=updateSubmittalResponse';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllSubmittalResponseAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=updateAllSubmittalResponseAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteSubmittalResponse(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Submittal Response?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=deleteSubmittalResponse';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveSubmittalResponse(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'submittal_responses-ajax.php?method=saveSubmittalResponse';
		}
...
function buildSubmittalResponseHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + submittal_response_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					submittal_response_id = parseInputToMySQLUnsignedInt(submittal_response_id);
				}
				ajaxQueryString = ajaxQueryString + '&submittal_response_id=' + encodeURIComponent(submittal_response_id);
			}
		}
		...
		if ($("#" + submittal_id_element_id).length) {
			...
			submittal_id = parseInputToInt(submittal_id);
			ajaxQueryString = ajaxQueryString + '&submittal_id=' + encodeURIComponent(submittal_id);
		}

		var submittal_response_sequence_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--submittal_response_sequence_number--' + uniqueId;
		if ($("#" + submittal_response_sequence_number_element_id).length) {
			var submittal_response_sequence_number = $("#" + submittal_response_sequence_number_element_id).val();
			submittal_response_sequence_number = parseInputToInt(submittal_response_sequence_number);
			ajaxQueryString = ajaxQueryString + '&submittal_response_sequence_number=' + encodeURIComponent(submittal_response_sequence_number);
		}
		var submittal_response_type_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--submittal_response_type_id--' + uniqueId;
		if ($("#" + submittal_response_type_id_element_id).length) {
			var submittal_response_type_id = $("#" + submittal_response_type_id_element_id).val();
			submittal_response_type_id = parseInputToInt(submittal_response_type_id);
			ajaxQueryString = ajaxQueryString + '&submittal_response_type_id=' + encodeURIComponent(submittal_response_type_id);
		}

		var su_responder_contact_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--su_responder_contact_id--' + uniqueId;
		if ($("#" + su_responder_contact_id_element_id).length) {
			var su_responder_contact_id = $("#" + su_responder_contact_id_element_id).val();
			su_responder_contact_id = parseInputToInt(su_responder_contact_id);
			ajaxQueryString = ajaxQueryString + '&su_responder_contact_id=' + encodeURIComponent(su_responder_contact_id);
		}

		var su_responder_contact_company_office_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--su_responder_contact_company_office_id--' + uniqueId;
		if ($("#" + su_responder_contact_company_office_id_element_id).length) {
			var su_responder_contact_company_office_id = $("#" + su_responder_contact_company_office_id_element_id).val();
			su_responder_contact_company_office_id = parseInputToInt(su_responder_contact_company_office_id);
			ajaxQueryString = ajaxQueryString + '&su_responder_contact_company_office_id=' + encodeURIComponent(su_responder_contact_company_office_id);
		}

		var su_responder_phone_contact_company_office_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--su_responder_phone_contact_company_office_phone_number_id--' + uniqueId;
		if ($("#" + su_responder_phone_contact_company_office_phone_number_id_element_id).length) {
			var su_responder_phone_contact_company_office_phone_number_id = $("#" + su_responder_phone_contact_company_office_phone_number_id_element_id).val();
			su_responder_phone_contact_company_office_phone_number_id = parseInputToInt(su_responder_phone_contact_company_office_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&su_responder_phone_contact_company_office_phone_number_id=' + encodeURIComponent(su_responder_phone_contact_company_office_phone_number_id);
		}

		var su_responder_fax_contact_company_office_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--su_responder_fax_contact_company_office_phone_number_id--' + uniqueId;
		if ($("#" + su_responder_fax_contact_company_office_phone_number_id_element_id).length) {
			var su_responder_fax_contact_company_office_phone_number_id = $("#" + su_responder_fax_contact_company_office_phone_number_id_element_id).val();
			su_responder_fax_contact_company_office_phone_number_id = parseInputToInt(su_responder_fax_contact_company_office_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&su_responder_fax_contact_company_office_phone_number_id=' + encodeURIComponent(su_responder_fax_contact_company_office_phone_number_id);
		}

		var su_responder_contact_mobile_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--su_responder_contact_mobile_phone_number_id--' + uniqueId;
		if ($("#" + su_responder_contact_mobile_phone_number_id_element_id).length) {
			var su_responder_contact_mobile_phone_number_id = $("#" + su_responder_contact_mobile_phone_number_id_element_id).val();
			su_responder_contact_mobile_phone_number_id = parseInputToInt(su_responder_contact_mobile_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&su_responder_contact_mobile_phone_number_id=' + encodeURIComponent(su_responder_contact_mobile_phone_number_id);
		}

		var submittal_response_title_element_id = attributeGroupName + '--' + attributeSubgroupName + '--submittal_response_title--' + uniqueId;
		if ($("#" + submittal_response_title_element_id).length) {
			var submittal_response_title = $("#" + submittal_response_title_element_id).val();
			ajaxQueryString = ajaxQueryString + '&submittal_response_title=' + encodeURIComponent(submittal_response_title);
		}
		var submittal_response_element_id = attributeGroupName + '--' + attributeSubgroupName + '--submittal_response--' + uniqueId;
		if ($("#" + submittal_response_element_id).length) {
			$("#" + submittal_response_element_id).keyup(function() {
				$("#" + submittal_response_element_id).removeClass('redBorderThick');
			});
			...
			{
				$("#" + submittal_response_element_id).removeClass('redBorderThick');
			ajaxQueryString = ajaxQueryString + '&submittal_response=' + encodeURIComponent(submittal_response);
		}
		}
...
function filterSubmittalResponseHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'submittal_response_id':
		...
		case 'submittal_id':
			...
			inputDataFiltered = true;
			break;
		case 'submittal_response_sequence_number':
			var newValue = parseInputToMySQLUnsignedSmallInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'submittal_response_type_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'su_responder_contact_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'su_responder_contact_company_office_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'su_responder_phone_contact_company_office_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'su_responder_fax_contact_company_office_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'su_responder_contact_mobile_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'modified':
