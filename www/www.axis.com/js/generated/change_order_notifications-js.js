 ...
 */
function createChangeOrderNotification(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Notification';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Notifications';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_notification-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_notifications';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=createChangeOrderNotification';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderNotificationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderNotification(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=loadChangeOrderNotification';
		}
...
function loadAllChangeOrderNotificationRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=loadAllChangeOrderNotificationRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderNotification(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderNotificationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=updateChangeOrderNotification';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderNotificationAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=updateAllChangeOrderNotificationAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderNotification(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Notification?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=deleteChangeOrderNotification';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderNotification(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_notifications-ajax.php?method=saveChangeOrderNotification';
		}
...
function buildChangeOrderNotificationHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if ($("#" + change_order_id_element_id).length) {
			...
			change_order_id = parseInputToInt(change_order_id);
			ajaxQueryString = ajaxQueryString + '&change_order_id=' + encodeURIComponent(change_order_id);
		}

		var change_order_notification_timestamp_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_notification_timestamp--' + uniqueId;
		if ($("#" + change_order_notification_timestamp_element_id).length) {
			var change_order_notification_timestamp = $("#" + change_order_notification_timestamp_element_id).val();
			change_order_notification_timestamp = convertTimestampToMySQLFormat(change_order_notification_timestamp);
			ajaxQueryString = ajaxQueryString + '&change_order_notification_timestamp=' + encodeURIComponent(change_order_notification_timestamp);
		}
...
function filterChangeOrderNotificationHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	...
	switch (attributeName) {
		...
		case 'change_order_id':
			...
			inputDataFiltered = true;
			break;
		case 'change_order_notification_timestamp':
