 ...
 */
function createJobsiteOffsiteworkActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Offsitework Activity';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Offsitework Activities';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_offsitework_activity-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_offsitework_activities';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=createJobsiteOffsiteworkActivity';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteOffsiteworkActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteOffsiteworkActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=loadJobsiteOffsiteworkActivity';
		}
		...
		var jobsite_offsitework_activity_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_activity_id--' + uniqueId;
		if ($("#" + jobsite_offsitework_activity_id_element_id).length) {
			var jobsite_offsitework_activity_id = $("#" + jobsite_offsitework_activity_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_activity_id=' + encodeURIComponent(jobsite_offsitework_activity_id);
		}
...
function loadAllJobsiteOffsiteworkActivityRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=loadAllJobsiteOffsiteworkActivityRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteOffsiteworkActivity(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteOffsiteworkActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=updateJobsiteOffsiteworkActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteOffsiteworkActivityAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=updateAllJobsiteOffsiteworkActivityAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteOffsiteworkActivity(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Offsitework Activity?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=deleteJobsiteOffsiteworkActivity';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteOffsiteworkActivity(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activities-ajax.php?method=saveJobsiteOffsiteworkActivity';
		}
...
function buildJobsiteOffsiteworkActivityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_offsitework_activity_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_offsitework_activity_id = parseInputToMySQLUnsignedInt(jobsite_offsitework_activity_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_activity_id=' + encodeURIComponent(jobsite_offsitework_activity_id);
			}
		}
...
function filterJobsiteOffsiteworkActivityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_offsitework_activity_id':
