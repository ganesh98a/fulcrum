 ...
 */
function createChangeOrderResponse(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Response';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Responses';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_response-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_responses';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=createChangeOrderResponse';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderResponseHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderResponse(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=loadChangeOrderResponse';
		}
		...
		var change_order_response_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_response_id--' + uniqueId;
		if ($("#" + change_order_response_id_element_id).length) {
			var change_order_response_id = $("#" + change_order_response_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_response_id=' + encodeURIComponent(change_order_response_id);
		}
...
function loadAllChangeOrderResponseRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=loadAllChangeOrderResponseRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderResponse(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderResponseHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=updateChangeOrderResponse';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderResponseAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=updateAllChangeOrderResponseAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderResponse(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Response?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=deleteChangeOrderResponse';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderResponse(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_responses-ajax.php?method=saveChangeOrderResponse';
		}
...
function buildChangeOrderResponseHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + change_order_response_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					change_order_response_id = parseInputToMySQLUnsignedInt(change_order_response_id);
				}
				ajaxQueryString = ajaxQueryString + '&change_order_response_id=' + encodeURIComponent(change_order_response_id);
			}
		}
		...
		var change_order_response_sequence_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_response_sequence_number--' + uniqueId;
		if ($("#" + change_order_response_sequence_number_element_id).length) {
			var change_order_response_sequence_number = $("#" + change_order_response_sequence_number_element_id).val();
			change_order_response_sequence_number = parseInputToInt(change_order_response_sequence_number);
			ajaxQueryString = ajaxQueryString + '&change_order_response_sequence_number=' + encodeURIComponent(change_order_response_sequence_number);
		}
		...
		if ($("#" + change_order_response_type_id_element_id).length) {
			...
			change_order_response_type_id = parseInputToInt(change_order_response_type_id);
			ajaxQueryString = ajaxQueryString + '&change_order_response_type_id=' + encodeURIComponent(change_order_response_type_id);
		}

		var co_responder_contact_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--co_responder_contact_id--' + uniqueId;
		if ($("#" + co_responder_contact_id_element_id).length) {
			var co_responder_contact_id = $("#" + co_responder_contact_id_element_id).val();
			co_responder_contact_id = parseInputToInt(co_responder_contact_id);
			ajaxQueryString = ajaxQueryString + '&co_responder_contact_id=' + encodeURIComponent(co_responder_contact_id);
		}

		var co_responder_contact_company_office_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--co_responder_contact_company_office_id--' + uniqueId;
		if ($("#" + co_responder_contact_company_office_id_element_id).length) {
			var co_responder_contact_company_office_id = $("#" + co_responder_contact_company_office_id_element_id).val();
			co_responder_contact_company_office_id = parseInputToInt(co_responder_contact_company_office_id);
			ajaxQueryString = ajaxQueryString + '&co_responder_contact_company_office_id=' + encodeURIComponent(co_responder_contact_company_office_id);
		}

		var co_responder_phone_contact_company_office_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--co_responder_phone_contact_company_office_phone_number_id--' + uniqueId;
		if ($("#" + co_responder_phone_contact_company_office_phone_number_id_element_id).length) {
			var co_responder_phone_contact_company_office_phone_number_id = $("#" + co_responder_phone_contact_company_office_phone_number_id_element_id).val();
			co_responder_phone_contact_company_office_phone_number_id = parseInputToInt(co_responder_phone_contact_company_office_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&co_responder_phone_contact_company_office_phone_number_id=' + encodeURIComponent(co_responder_phone_contact_company_office_phone_number_id);
		}

		var co_responder_fax_contact_company_office_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--co_responder_fax_contact_company_office_phone_number_id--' + uniqueId;
		if ($("#" + co_responder_fax_contact_company_office_phone_number_id_element_id).length) {
			var co_responder_fax_contact_company_office_phone_number_id = $("#" + co_responder_fax_contact_company_office_phone_number_id_element_id).val();
			co_responder_fax_contact_company_office_phone_number_id = parseInputToInt(co_responder_fax_contact_company_office_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&co_responder_fax_contact_company_office_phone_number_id=' + encodeURIComponent(co_responder_fax_contact_company_office_phone_number_id);
		}

		var co_responder_contact_mobile_phone_number_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--co_responder_contact_mobile_phone_number_id--' + uniqueId;
		if ($("#" + co_responder_contact_mobile_phone_number_id_element_id).length) {
			var co_responder_contact_mobile_phone_number_id = $("#" + co_responder_contact_mobile_phone_number_id_element_id).val();
			co_responder_contact_mobile_phone_number_id = parseInputToInt(co_responder_contact_mobile_phone_number_id);
			ajaxQueryString = ajaxQueryString + '&co_responder_contact_mobile_phone_number_id=' + encodeURIComponent(co_responder_contact_mobile_phone_number_id);
		}

		var change_order_response_title_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_response_title--' + uniqueId;
		if ($("#" + change_order_response_title_element_id).length) {
			var change_order_response_title = $("#" + change_order_response_title_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_response_title=' + encodeURIComponent(change_order_response_title);
		}
		var change_order_response_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_response--' + uniqueId;
		if ($("#" + change_order_response_element_id).length) {
			var change_order_response = $("#" + change_order_response_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_response=' + encodeURIComponent(change_order_response);
		}
...
function filterChangeOrderResponseHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'change_order_response_id':
		...
		case 'change_order_id':
			...
			inputDataFiltered = true;
			break;
		case 'change_order_response_sequence_number':
		...
		case 'change_order_response_type_id':
			...
			inputDataFiltered = true;
			break;
		case 'co_responder_contact_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'co_responder_contact_company_office_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'co_responder_phone_contact_company_office_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'co_responder_fax_contact_company_office_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'co_responder_contact_mobile_phone_number_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'modified':
