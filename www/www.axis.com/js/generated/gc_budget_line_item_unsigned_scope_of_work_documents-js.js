 ...
 */
function createGcBudgetLineItemUnsignedScopeOfWorkDocument(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Gc Budget Line Item Unsigned Scope Of Work Document';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Gc Budget Line Item Unsigned Scope Of Work Documents';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-gc_budget_line_item_unsigned_scope_of_work_document-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'gc_budget_line_item_unsigned_scope_of_work_documents';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=createGcBudgetLineItemUnsignedScopeOfWorkDocument';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildGcBudgetLineItemUnsignedScopeOfWorkDocumentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadGcBudgetLineItemUnsignedScopeOfWorkDocument(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=loadGcBudgetLineItemUnsignedScopeOfWorkDocument';
		}
		...
		var gc_budget_line_item_unsigned_scope_of_work_document_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--gc_budget_line_item_unsigned_scope_of_work_document_id--' + uniqueId;
		if ($("#" + gc_budget_line_item_unsigned_scope_of_work_document_id_element_id).length) {
			var gc_budget_line_item_unsigned_scope_of_work_document_id = $("#" + gc_budget_line_item_unsigned_scope_of_work_document_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&gc_budget_line_item_unsigned_scope_of_work_document_id=' + encodeURIComponent(gc_budget_line_item_unsigned_scope_of_work_document_id);
		}
...
function loadAllGcBudgetLineItemUnsignedScopeOfWorkDocumentRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=loadAllGcBudgetLineItemUnsignedScopeOfWorkDocumentRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateGcBudgetLineItemUnsignedScopeOfWorkDocument(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterGcBudgetLineItemUnsignedScopeOfWorkDocumentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=updateGcBudgetLineItemUnsignedScopeOfWorkDocument';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllGcBudgetLineItemUnsignedScopeOfWorkDocumentAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=updateAllGcBudgetLineItemUnsignedScopeOfWorkDocumentAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteGcBudgetLineItemUnsignedScopeOfWorkDocument(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Gc Budget Line Item Unsigned Scope Of Work Document?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=deleteGcBudgetLineItemUnsignedScopeOfWorkDocument';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveGcBudgetLineItemUnsignedScopeOfWorkDocument(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'gc_budget_line_item_unsigned_scope_of_work_documents-ajax.php?method=saveGcBudgetLineItemUnsignedScopeOfWorkDocument';
		}
...
function buildGcBudgetLineItemUnsignedScopeOfWorkDocumentHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + gc_budget_line_item_unsigned_scope_of_work_document_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					gc_budget_line_item_unsigned_scope_of_work_document_id = parseInputToMySQLUnsignedInt(gc_budget_line_item_unsigned_scope_of_work_document_id);
				}
				ajaxQueryString = ajaxQueryString + '&gc_budget_line_item_unsigned_scope_of_work_document_id=' + encodeURIComponent(gc_budget_line_item_unsigned_scope_of_work_document_id);
			}
		}
		...
		var unsigned_scope_of_work_document_sequence_number_element_id = attributeGroupName + '--' + attributeSubgroupName + '--unsigned_scope_of_work_document_sequence_number--' + uniqueId;
		if ($("#" + unsigned_scope_of_work_document_sequence_number_element_id).length) {
			var unsigned_scope_of_work_document_sequence_number = $("#" + unsigned_scope_of_work_document_sequence_number_element_id).val();
			unsigned_scope_of_work_document_sequence_number = parseInputToInt(unsigned_scope_of_work_document_sequence_number);
			ajaxQueryString = ajaxQueryString + '&unsigned_scope_of_work_document_sequence_number=' + encodeURIComponent(unsigned_scope_of_work_document_sequence_number);
		}
		var unsigned_scope_of_work_document_file_manager_file_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--unsigned_scope_of_work_document_file_manager_file_id--' + uniqueId;
		if ($("#" + unsigned_scope_of_work_document_file_manager_file_id_element_id).length) {
			var unsigned_scope_of_work_document_file_manager_file_id = $("#" + unsigned_scope_of_work_document_file_manager_file_id_element_id).val();
			unsigned_scope_of_work_document_file_manager_file_id = parseInputToInt(unsigned_scope_of_work_document_file_manager_file_id);
			ajaxQueryString = ajaxQueryString + '&unsigned_scope_of_work_document_file_manager_file_id=' + encodeURIComponent(unsigned_scope_of_work_document_file_manager_file_id);
		}

		var unsigned_scope_of_work_document_file_sha1_element_id = attributeGroupName + '--' + attributeSubgroupName + '--unsigned_scope_of_work_document_file_sha1--' + uniqueId;
		if ($("#" + unsigned_scope_of_work_document_file_sha1_element_id).length) {
			var unsigned_scope_of_work_document_file_sha1 = $("#" + unsigned_scope_of_work_document_file_sha1_element_id).val();
			ajaxQueryString = ajaxQueryString + '&unsigned_scope_of_work_document_file_sha1=' + encodeURIComponent(unsigned_scope_of_work_document_file_sha1);
		}
...
function filterGcBudgetLineItemUnsignedScopeOfWorkDocumentHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'gc_budget_line_item_unsigned_scope_of_work_document_id':
		...
		case 'gc_budget_line_item_id':
			...
			inputDataFiltered = true;
			break;
		case 'unsigned_scope_of_work_document_sequence_number':
			var newValue = parseInputToMySQLUnsignedSmallInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'unsigned_scope_of_work_document_file_manager_file_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'created':
