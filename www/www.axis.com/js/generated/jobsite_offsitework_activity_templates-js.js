 ...
 */
function createJobsiteOffsiteworkActivityTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Offsitework Activity Template';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Offsitework Activity Templates';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_offsitework_activity_template-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_offsitework_activity_templates';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=createJobsiteOffsiteworkActivityTemplate';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteOffsiteworkActivityTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteOffsiteworkActivityTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=loadJobsiteOffsiteworkActivityTemplate';
		}
		...
		var jobsite_offsitework_activity_template_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_activity_template_id--' + uniqueId;
		if ($("#" + jobsite_offsitework_activity_template_id_element_id).length) {
			var jobsite_offsitework_activity_template_id = $("#" + jobsite_offsitework_activity_template_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_activity_template_id=' + encodeURIComponent(jobsite_offsitework_activity_template_id);
		}
...
function loadAllJobsiteOffsiteworkActivityTemplateRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=loadAllJobsiteOffsiteworkActivityTemplateRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteOffsiteworkActivityTemplate(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteOffsiteworkActivityTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=updateJobsiteOffsiteworkActivityTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteOffsiteworkActivityTemplateAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=updateAllJobsiteOffsiteworkActivityTemplateAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteOffsiteworkActivityTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Offsitework Activity Template?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=deleteJobsiteOffsiteworkActivityTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteOffsiteworkActivityTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates-ajax.php?method=saveJobsiteOffsiteworkActivityTemplate';
		}
...
function buildJobsiteOffsiteworkActivityTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_offsitework_activity_template_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_offsitework_activity_template_id = parseInputToMySQLUnsignedInt(jobsite_offsitework_activity_template_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_activity_template_id=' + encodeURIComponent(jobsite_offsitework_activity_template_id);
			}
		}

		var jobsite_activity_list_template_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_activity_list_template_id--' + uniqueId;
		if ($("#" + jobsite_activity_list_template_id_element_id).length) {
			var jobsite_activity_list_template_id = $("#" + jobsite_activity_list_template_id_element_id).val();
			jobsite_activity_list_template_id = parseInputToInt(jobsite_activity_list_template_id);
			ajaxQueryString = ajaxQueryString + '&jobsite_activity_list_template_id=' + encodeURIComponent(jobsite_activity_list_template_id);
		}

		var jobsite_offsitework_activity_label_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_offsitework_activity_label--' + uniqueId;
		if ($("#" + jobsite_offsitework_activity_label_element_id).length) {
			var jobsite_offsitework_activity_label = $("#" + jobsite_offsitework_activity_label_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_offsitework_activity_label=' + encodeURIComponent(jobsite_offsitework_activity_label);
		}
...
function filterJobsiteOffsiteworkActivityTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_offsitework_activity_template_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'jobsite_activity_list_template_id':
			var newValue = parseInputToMySQLUnsignedInt(tmpValue);
			inputDataFiltered = true;
			break;
		case 'sort_order':
