 ...
 */
function createCostCodeAlias(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Cost Code Alias';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Cost Code Aliases';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-cost_code_alias-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'cost_code_aliases';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=createCostCodeAlias';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildCostCodeAliasHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadCostCodeAlias(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=loadCostCodeAlias';
		}
		...
		var cost_code_alias_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_alias_id--' + uniqueId;
		if ($("#" + cost_code_alias_id_element_id).length) {
			var cost_code_alias_id = $("#" + cost_code_alias_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_alias_id=' + encodeURIComponent(cost_code_alias_id);
		}
...
function loadAllCostCodeAliasRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=loadAllCostCodeAliasRecords';
		}
...
function updateCostCodeAlias(element, options)
{
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterCostCodeAliasHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=updateCostCodeAlias';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllCostCodeAliasAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=updateAllCostCodeAliasAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteCostCodeAlias(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Cost Code Alias?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=deleteCostCodeAlias';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveCostCodeAlias(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'cost_code_aliases-ajax.php?method=saveCostCodeAlias';
		}
...
function buildCostCodeAliasHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + cost_code_alias_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					cost_code_alias_id = parseInputToMySQLUnsignedInt(cost_code_alias_id);
				}
				ajaxQueryString = ajaxQueryString + '&cost_code_alias_id=' + encodeURIComponent(cost_code_alias_id);
			}
		}
		...
		if ($("#" + cost_code_id_element_id).length) {
			...
			cost_code_id = parseInputToInt(cost_code_id);
		...
		if ($("#" + cost_code_division_alias_id_element_id).length) {
			...
			cost_code_division_alias_id = parseInputToInt(cost_code_division_alias_id);
			ajaxQueryString = ajaxQueryString + '&cost_code_division_alias_id=' + encodeURIComponent(cost_code_division_alias_id);
		}

		var cost_code_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_alias--' + uniqueId;
		if ($("#" + cost_code_alias_element_id).length) {
			var cost_code_alias = $("#" + cost_code_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_alias=' + encodeURIComponent(cost_code_alias);
		}
		var cost_code_description_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_description_alias--' + uniqueId;
		if ($("#" + cost_code_description_alias_element_id).length) {
			var cost_code_description_alias = $("#" + cost_code_description_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_description_alias=' + encodeURIComponent(cost_code_description_alias);
		}
		var cost_code_description_abbreviation_alias_element_id = attributeGroupName + '--' + attributeSubgroupName + '--cost_code_description_abbreviation_alias--' + uniqueId;
		if ($("#" + cost_code_description_abbreviation_alias_element_id).length) {
			var cost_code_description_abbreviation_alias = $("#" + cost_code_description_abbreviation_alias_element_id).val();
			ajaxQueryString = ajaxQueryString + '&cost_code_description_abbreviation_alias=' + encodeURIComponent(cost_code_description_abbreviation_alias);
		}
...
function filterCostCodeAliasHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
