 ...
 */
function createJobsiteOffsiteworkActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Offsitework Activity Template To Cost Code';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Offsitework Activity Templates To Cost Codes';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_offsitework_activity_template_to_cost_code-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_offsitework_activity_templates_to_cost_codes';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=createJobsiteOffsiteworkActivityTemplateToCostCode';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteOffsiteworkActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteOffsiteworkActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=loadJobsiteOffsiteworkActivityTemplateToCostCode';
		}
...
function loadAllJobsiteOffsiteworkActivityTemplateToCostCodeRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=loadAllJobsiteOffsiteworkActivityTemplateToCostCodeRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteOffsiteworkActivityTemplateToCostCode(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteOffsiteworkActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=updateJobsiteOffsiteworkActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteOffsiteworkActivityTemplateToCostCodeAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=updateAllJobsiteOffsiteworkActivityTemplateToCostCodeAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteOffsiteworkActivityTemplateToCostCode(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Offsitework Activity Template To Cost Code?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=deleteJobsiteOffsiteworkActivityTemplateToCostCode';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteOffsiteworkActivityTemplateToCostCode(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_offsitework_activity_templates_to_cost_codes-ajax.php?method=saveJobsiteOffsiteworkActivityTemplateToCostCode';
		}
...
function buildJobsiteOffsiteworkActivityTemplateToCostCodeHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
...
function filterJobsiteOffsiteworkActivityTemplateToCostCodeHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
