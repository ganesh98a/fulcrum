 ...
 */
function createJobsiteBuildingActivityTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Building Activity Template';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Building Activity Templates';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_building_activity_template-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_building_activity_templates';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=createJobsiteBuildingActivityTemplate';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteBuildingActivityTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteBuildingActivityTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=loadJobsiteBuildingActivityTemplate';
		}
		...
		var jobsite_building_activity_template_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_building_activity_template_id--' + uniqueId;
		if ($("#" + jobsite_building_activity_template_id_element_id).length) {
			var jobsite_building_activity_template_id = $("#" + jobsite_building_activity_template_id_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_building_activity_template_id=' + encodeURIComponent(jobsite_building_activity_template_id);
		}
...
function loadAllJobsiteBuildingActivityTemplateRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=loadAllJobsiteBuildingActivityTemplateRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteBuildingActivityTemplate(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteBuildingActivityTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=updateJobsiteBuildingActivityTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteBuildingActivityTemplateAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=updateAllJobsiteBuildingActivityTemplateAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteBuildingActivityTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Building Activity Template?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=deleteJobsiteBuildingActivityTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteBuildingActivityTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_building_activity_templates-ajax.php?method=saveJobsiteBuildingActivityTemplate';
		}
...
function buildJobsiteBuildingActivityTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_building_activity_template_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_building_activity_template_id = parseInputToMySQLUnsignedInt(jobsite_building_activity_template_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_building_activity_template_id=' + encodeURIComponent(jobsite_building_activity_template_id);
			}
		}
		...
		var jobsite_building_activity_label_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_building_activity_label--' + uniqueId;
		if ($("#" + jobsite_building_activity_label_element_id).length) {
			var jobsite_building_activity_label = $("#" + jobsite_building_activity_label_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_building_activity_label=' + encodeURIComponent(jobsite_building_activity_label);
		}
...
function filterJobsiteBuildingActivityTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
	inputDataFiltered = false;

	switch (attributeName) {
		case 'jobsite_building_activity_template_id':
