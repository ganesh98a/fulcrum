 ...
 */
function createChangeOrderPriority(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Change Order Priority';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Change Order Priorities';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-change_order_priority-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'change_order_priorities';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=createChangeOrderPriority';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildChangeOrderPriorityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadChangeOrderPriority(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=loadChangeOrderPriority';
		}
...
function loadAllChangeOrderPriorityRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=loadAllChangeOrderPriorityRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateChangeOrderPriority(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterChangeOrderPriorityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=updateChangeOrderPriority';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllChangeOrderPriorityAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=updateAllChangeOrderPriorityAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteChangeOrderPriority(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Change Order Priority?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=deleteChangeOrderPriority';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveChangeOrderPriority(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'change_order_priorities-ajax.php?method=saveChangeOrderPriority';
		}
...
function buildChangeOrderPriorityHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + change_order_priority_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					change_order_priority_id = parseInputToMySQLUnsignedInt(change_order_priority_id);
				}
				ajaxQueryString = ajaxQueryString + '&change_order_priority_id=' + encodeURIComponent(change_order_priority_id);
			}
		}

		var change_order_priority_element_id = attributeGroupName + '--' + attributeSubgroupName + '--change_order_priority--' + uniqueId;
		if ($("#" + change_order_priority_element_id).length) {
			var change_order_priority = $("#" + change_order_priority_element_id).val();
			ajaxQueryString = ajaxQueryString + '&change_order_priority=' + encodeURIComponent(change_order_priority);
		}
...
function filterChangeOrderPriorityHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
