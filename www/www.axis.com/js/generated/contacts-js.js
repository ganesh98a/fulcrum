 ...
 */
function createContact(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Contact';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Contacts';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-contact-record';
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildContactHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadContact(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=loadContact';
		}
...
function loadAllContactRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=loadAllContactRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateContact(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterContactHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=updateContact';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllContactAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=updateAllContactAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteContact(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Contact?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=deleteContact';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveContact(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'contacts-ajax.php?method=saveContact';
		}
...
function buildContactHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		var user_id_element_id = attributeGroupName + '--' + attributeSubgroupName + '--user_id--' + uniqueId;
		if ($("#" + user_id_element_id).length) {
			var user_id = $("#" + user_id_element_id).val();
			user_id = parseInputToInt(user_id);
			ajaxQueryString = ajaxQueryString + '&user_id=' + encodeURIComponent(user_id);
		}
		...
		var email_element_id = attributeGroupName + '--' + attributeSubgroupName + '--email--' + uniqueId;
		if ($("#" + email_element_id).length) {
			var email = $("#" + email_element_id).val();
			ajaxQueryString = ajaxQueryString + '&email=' + encodeURIComponent(email);
		}

		var mobilephone_element_id = attributeGroupName + '--' + attributeSubgroupName + '--mobilephone--' + uniqueId;
		if ($("#" + mobilephone_element_id).length) {
			var mobilephone = $("#" + mobilephone_element_id).val();
			ajaxQueryString = ajaxQueryString + '&mobilephone=' + encodeURIComponent(mobilephone);
		}
		
		var name_prefix_element_id = attributeGroupName + '--' + attributeSubgroupName + '--name_prefix--' + uniqueId;
		if ($("#" + name_prefix_element_id).length) {
			var name_prefix = $("#" + name_prefix_element_id).val();
			ajaxQueryString = ajaxQueryString + '&name_prefix=' + encodeURIComponent(name_prefix);
		}
		var first_name_element_id = attributeGroupName + '--' + attributeSubgroupName + '--first_name--' + uniqueId;
		if ($("#" + first_name_element_id).length) {
			var first_name = $("#" + first_name_element_id).val();
			ajaxQueryString = ajaxQueryString + '&first_name=' + encodeURIComponent(first_name);
		}
		var additional_name_element_id = attributeGroupName + '--' + attributeSubgroupName + '--additional_name--' + uniqueId;
		if ($("#" + additional_name_element_id).length) {
			var additional_name = $("#" + additional_name_element_id).val();
			ajaxQueryString = ajaxQueryString + '&additional_name=' + encodeURIComponent(additional_name);
		}
		var middle_name_element_id = attributeGroupName + '--' + attributeSubgroupName + '--middle_name--' + uniqueId;
		if ($("#" + middle_name_element_id).length) {
			var middle_name = $("#" + middle_name_element_id).val();
			ajaxQueryString = ajaxQueryString + '&middle_name=' + encodeURIComponent(middle_name);
		}
		var last_name_element_id = attributeGroupName + '--' + attributeSubgroupName + '--last_name--' + uniqueId;
		if ($("#" + last_name_element_id).length) {
			var last_name = $("#" + last_name_element_id).val();
			ajaxQueryString = ajaxQueryString + '&last_name=' + encodeURIComponent(last_name);
		}
		var name_suffix_element_id = attributeGroupName + '--' + attributeSubgroupName + '--name_suffix--' + uniqueId;
		if ($("#" + name_suffix_element_id).length) {
			var name_suffix = $("#" + name_suffix_element_id).val();
			ajaxQueryString = ajaxQueryString + '&name_suffix=' + encodeURIComponent(name_suffix);
		}
		var title_element_id = attributeGroupName + '--' + attributeSubgroupName + '--title--' + uniqueId;
		if ($("#" + title_element_id).length) {
			var title = $("#" + title_element_id).val();
			ajaxQueryString = ajaxQueryString + '&title=' + encodeURIComponent(title);
		}
		var vendor_flag_element_id = attributeGroupName + '--' + attributeSubgroupName + '--vendor_flag--' + uniqueId;
		if ($("#" + vendor_flag_element_id).length) {
			var vendor_flag = $("#" + vendor_flag_element_id).val();
			if ($("#" + vendor_flag_element_id).is(':checkbox')) {
				if ($("#" + vendor_flag_element_id).is(':checked')) {
					vendor_flag = 'Y';
				} else {
					vendor_flag = 'N';
				}
			}
			ajaxQueryString = ajaxQueryString + '&vendor_flag=' + encodeURIComponent(vendor_flag);
		}
...
function filterContactHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
