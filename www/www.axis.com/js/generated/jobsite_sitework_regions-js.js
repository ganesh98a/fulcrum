 ...
 */
function createJobsiteSiteworkRegion(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Sitework Region';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Sitework Regions';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_sitework_region-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_sitework_regions';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=createJobsiteSiteworkRegion';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteSiteworkRegionHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteSiteworkRegion(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=loadJobsiteSiteworkRegion';
		}
...
function loadAllJobsiteSiteworkRegionRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=loadAllJobsiteSiteworkRegionRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteSiteworkRegion(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteSiteworkRegionHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=updateJobsiteSiteworkRegion';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteSiteworkRegionAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=updateAllJobsiteSiteworkRegionAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteSiteworkRegion(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Sitework Region?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=deleteJobsiteSiteworkRegion';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteSiteworkRegion(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_sitework_regions-ajax.php?method=saveJobsiteSiteworkRegion';
		}
...
function buildJobsiteSiteworkRegionHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_sitework_region_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_sitework_region_id = parseInputToMySQLUnsignedInt(jobsite_sitework_region_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_sitework_region_id=' + encodeURIComponent(jobsite_sitework_region_id);
			}
		}
		...
		var jobsite_sitework_region_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_sitework_region--' + uniqueId;
		if ($("#" + jobsite_sitework_region_element_id).length) {
			var jobsite_sitework_region = $("#" + jobsite_sitework_region_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_region=' + encodeURIComponent(jobsite_sitework_region);
		}
		var jobsite_sitework_region_description_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_sitework_region_description--' + uniqueId;
		if ($("#" + jobsite_sitework_region_description_element_id).length) {
			var jobsite_sitework_region_description = $("#" + jobsite_sitework_region_description_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_sitework_region_description=' + encodeURIComponent(jobsite_sitework_region_description);
		}
...
function filterJobsiteSiteworkRegionHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
