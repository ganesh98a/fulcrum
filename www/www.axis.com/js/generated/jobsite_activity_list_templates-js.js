 ...
 */
function createJobsiteActivityListTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.htmlRecordMetaAttributes) {
			...
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeGroupName		= 'Jobsite Activity List Template';
			htmlRecordMetaAttributesOptions.defaultFormattedAttributeSubgroupName	= 'Jobsite Activity List Templates';
			htmlRecordMetaAttributesOptions.defaultNewAttributeGroupName			= 'manage-jobsite_activity_list_template-record';
		...
		if (!optionsObjectIsEmpty && options.attributeSubgroupName) {
			...
			var attributeSubgroupName = 'jobsite_activity_list_templates';
		}

		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			var ajaxHandlerScript = options.ajaxHandlerScript;
		} else {
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=createJobsiteActivityListTemplate';
		}
		...
		if (!optionsObjectIsEmpty && options.skipBuildHtmlRecordAttributesAsAjaxQueryString) {
			...
			var htmlRecordAttributesAsAjaxQueryString = buildJobsiteActivityListTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, htmlRecordAttributeOptions);
...
function loadJobsiteActivityListTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=loadJobsiteActivityListTemplate';
		}
...
function loadAllJobsiteActivityListTemplateRecords(recordListContainerElementId, attributeGroupName, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=loadAllJobsiteActivityListTemplateRecords';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateJobsiteActivityListTemplate(element, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!inputDataFiltered) {
			var objReturn = filterJobsiteActivityListTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue);
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=updateJobsiteActivityListTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function updateAllJobsiteActivityListTemplateAttributes(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=updateAllJobsiteActivityListTemplateAttributes';
		}
 ...
 * options is an object with a collection of optional directives
 */
function deleteJobsiteActivityListTemplate(recordContainerElementId, attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (confirmDelete) {
			var confirmDeleteAnswer = window.confirm('Are You Sure That You Want To Delete This Jobsite Activity List Template?');
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=deleteJobsiteActivityListTemplate';
		}
 ...
 * options is an object with a collection of optional directives
 */
function saveJobsiteActivityListTemplate(attributeGroupName, uniqueId, options)
{
	// Debug
	//return;
	...
	try {
		...
		if (!optionsObjectIsEmpty && options.ajaxHandlerScript) {
			...
			var ajaxHandlerScript = 'jobsite_activity_list_templates-ajax.php?method=saveJobsiteActivityListTemplate';
		}
...
function buildJobsiteActivityListTemplateHtmlRecordAttributesAsAjaxQueryString(attributeGroupName, uniqueId, options)
{
	try {
		...
		if (!optionsObjectIsEmpty && options.includeId) {
			...
			if ($("#" + jobsite_activity_list_template_id_element_id).length) {
				...
				if (!optionsObjectIsEmpty && options.filterId) {
					jobsite_activity_list_template_id = parseInputToMySQLUnsignedInt(jobsite_activity_list_template_id);
				}
				ajaxQueryString = ajaxQueryString + '&jobsite_activity_list_template_id=' + encodeURIComponent(jobsite_activity_list_template_id);
			}
		}
		...
		var jobsite_activity_list_template_element_id = attributeGroupName + '--' + attributeSubgroupName + '--jobsite_activity_list_template--' + uniqueId;
		if ($("#" + jobsite_activity_list_template_element_id).length) {
			var jobsite_activity_list_template = $("#" + jobsite_activity_list_template_element_id).val();
			ajaxQueryString = ajaxQueryString + '&jobsite_activity_list_template=' + encodeURIComponent(jobsite_activity_list_template);
		}
...
function filterJobsiteActivityListTemplateHtmlRecordAttributeValueByAttributeName(attributeName, tmpValue)
{
