...
//Dynamic height for notes in delay log report
...
foreach($records as $row)
{
    ...
    $action     = $row['action'];
    $notes = str_replace("<br />", "\r", $notes);
    $numrows = getRowcount($notes);
    ...
    $alphaCharIn = 3;
    $objPHPExcel->getActiveSheet()->getRowDimension(($index))->setRowHeight($numrows== 1 ? $numrows * 12.75 + 2.25 : $numrows * 14.75 + 5);
