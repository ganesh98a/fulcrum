...
Response Date : $formattedRfiResponseDate \n$response_text
END_RFI_TABLE_TBODY;
       ...
       $alphaCharIn++;
       $objPHPExcel->getActiveSheet()->setCellValue($alphas[$alphaCharIn].$index,$rfiTableTbody);
    // $alphaCharIn++;
   }

   if($request_for_information_id == $rfidArray[$checkid-1] ){
