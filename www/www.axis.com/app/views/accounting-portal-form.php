...
// If No Access
if($userRole !="global_admin" && !$userCanViewAccount && (!$userCanManageAccount) || (!$userCanManageAccount &&(!$userCanViewAccount) ) ) {
...
$template->assign('projectName',$userCompanyName); // To display Company name in header
