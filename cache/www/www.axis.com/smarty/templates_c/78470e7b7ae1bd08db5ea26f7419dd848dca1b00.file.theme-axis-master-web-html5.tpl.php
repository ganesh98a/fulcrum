<?php /* Smarty version Smarty-3.0.8, created on 2022-07-13 13:41:22
         compiled from "C:/xampp5.6/htdocs/full_delay/fulcrum/www/www.axis.com/include/templates/theme-axis-master-web-html5.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2717362ceaf62d2a885-84002469%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78470e7b7ae1bd08db5ea26f7419dd848dca1b00' => 
    array (
      0 => 'C:/xampp5.6/htdocs/full_delay/fulcrum/www/www.axis.com/include/templates/theme-axis-master-web-html5.tpl',
      1 => 1655285932,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2717362ceaf62d2a885-84002469',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_block_php')) include 'C:\xampp5.6\htdocs\full_delay\fulcrum\engine\include\smarty-3.0.8\plugins\block.php.php';
...
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('currentlySelectedProjectName',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('currentlySelectedProjectName',null,true,false)->value))){?>
	<input id="currentlySelectedProjectName" name="currentlySelectedProjectName" type="hidden" value="<?php echo $_smarty_tpl->getVariable('currentlySelectedProjectName')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('currentlySelectedUserCompanyName',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('currentlySelectedUserCompanyName',null,true,false)->value))){?>
	<input id="currentlySelectedUserCompanyName" name="currentlySelectedUserCompanyName" type="hidden" value="<?php echo $_smarty_tpl->getVariable('currentlySelectedUserCompanyName')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('user_company_id',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('user_company_id',null,true,false)->value))){?>
	<input id="user_company_id" name="user_company_id" type="hidden" value="<?php echo $_smarty_tpl->getVariable('user_company_id')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('currentlySelectedProjectUserCompanyId',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('currentlySelectedProjectUserCompanyId',null,true,false)->value))){?>
	<input id="currentlySelectedProjectUserCompanyId" name="currentlySelectedProjectUserCompanyId" type="hidden" value="<?php echo $_smarty_tpl->getVariable('currentlySelectedProjectUserCompanyId')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('currentlyActiveContactId',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('currentlyActiveContactId',null,true,false)->value))){?>
	<input id="currentlyActiveContactId" name="currentlyActiveContactId" type="hidden" value="<?php echo $_smarty_tpl->getVariable('currentlyActiveContactId')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('logged_user_id',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('logged_user_id',null,true,false)->value))){?>
	<input id="logged_user_id" name="logged_user_id" type="hidden" value="<?php echo $_smarty_tpl->getVariable('logged_user_id')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('primary_contact_id',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('primary_contact_id',null,true,false)->value))){?>
	<input id="primary_contact_id" name="primary_contact_id" type="hidden" value="<?php echo $_smarty_tpl->getVariable('primary_contact_id')->value;?>
">
<?php }?>
<?php if ((isset($_smarty_tpl->getVariable('primary_contact_name',null,true,false)->value)&&!empty($_smarty_tpl->getVariable('primary_contact_name',null,true,false)->value))){?>
	<input id="primary_contact_name" name="primary_contact_name" type="hidden" value="<?php echo $_smarty_tpl->getVariable('primary_contact_name')->value;?>
">
<?php }?>
